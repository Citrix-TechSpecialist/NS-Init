...
class vpnvserver(base_resource) :
	...
	def __init__(self) :
		...
		self._rdpserverprofilename = ""
		self._windowsepapluginupgrade = ""
		self._linuxepapluginupgrade = ""
		self._macepapluginupgrade = ""
		self._userdomains = ""
		self._newname = ""
		self._ip = ""
		self._value = ""
	...
	@property
	def port(self) :
		ur"""TCP port on which the virtual server listens.<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	@property
	def dtls(self) :
		ur"""This option starts/stops the turn service on the vserver.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
			return self._dtls
		except Exception as e:
	...
	@property
	def loginonce(self) :
		ur"""This option enables/disables seamless SSO for this Vserver.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def httpprofilename(self) :
		ur"""Name of the HTTP profile to assign to this virtual server.<br/>Default value: "nshttp_default_strict_validation"<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def rdpserverprofilename(self) :
		ur"""Name of the RDP server profile associated with the vserver.<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
	...
	@property
	def csvserver(self) :
		ur"""Name of the CS vserver to which the VPN vserver is bound.
		"""
		try :
