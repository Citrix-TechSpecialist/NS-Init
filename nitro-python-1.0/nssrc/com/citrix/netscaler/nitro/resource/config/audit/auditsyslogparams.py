...
class auditsyslogparams(base_resource) :
	...
	@property
	def lsn(self) :
		ur"""Log the LSN messages.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._lsn
		except Exception as e:
	...
	@property
	def alg(self) :
		ur"""Log the ALG messages.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._alg
		except Exception as e:
	...
	def update(cls, client, resource) :
		ur""" Use this API to update auditsyslogparams.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of auditsyslogparams resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the auditsyslogparams resources that are configured on netscaler.
		"""
		try :
			if not name :
