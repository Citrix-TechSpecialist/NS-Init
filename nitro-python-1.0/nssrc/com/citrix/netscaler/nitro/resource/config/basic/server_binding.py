...
class server_binding(base_resource):
	...
	def server_servicegroup_bindings(self) :
		ur"""servicegroup that can be bound to server.
		"""
		try :
	...
	def server_service_bindings(self) :
		ur"""service that can be bound to server.
		"""
		try :
	...
	def server_gslbservice_bindings(self) :
		ur"""gslbservice that can be bound to server.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch server_binding resource.
		"""
		try :
