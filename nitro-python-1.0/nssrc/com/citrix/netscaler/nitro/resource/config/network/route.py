...
class route(base_resource) :
	...
	@property
	def ownergroup(self) :
		ur"""The owner node group in a Cluster for this route. If owner node group is not specified then the route is treated as Striped route.<br/>Default value: DEFAULT_NG<br/>Minimum length =  1.
		"""
		try :
