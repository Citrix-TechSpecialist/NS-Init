...
class authenticationsamlidpprofile(base_resource) :
	...
	def __init__(self) :
		...
		self._encryptassertion = ""
		self._encryptionalgorithm = ""
		self._samlbinding = ""
		self._skewtime = 0
		self._serviceproviderid = ""
		self.___count = 0

	@property
	def name(self) :
		ur"""Name for the new saml single sign-on profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Cannot be changed after an action is created.
	...
	def samlspcertname(self) :
		ur"""Name of the SSL certificate of SAML Relying Party. This certificate is used to verify signature of the incoming AuthnRequest from a Relying Party or Service Provider.<br/>Minimum length =  1.
		"""
		try :
	...
	def samlidpcertname(self) :
		ur"""Name of the signing authority as given in the SAML server's SSL certificate. This certificate is used to sign the SAMLResposne that is sent to Relying Party or Service Provider after successful authentication.<br/>Minimum length =  1.
		"""
		try :
	...
	def rejectunsignedrequests(self) :
		ur"""Option to Reject unsigned SAML Requests.<br/>Default value: ON<br/>Possible values = ON, OFF.
		"""
		try :
	...
	@property
	def audience(self) :
		ur"""Audience for which assertion sent by IdP is applicable. This is typically entity name or url that represents ServiceProvider.
		"""
		try :
	...
	@property
	def attribute1(self) :
		ur"""Name of attribute1 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute1friendlyname(self) :
		ur"""User-Friendly Name of attribute1 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute1format(self) :
		ur"""Format of Attribute1 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	@property
	def attribute2(self) :
		ur"""Name of attribute2 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute2expr(self) :
		ur"""Expression that will be evaluated to obtain attribute2's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute2friendlyname(self) :
		ur"""User-Friendly Name of attribute2 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute2format(self) :
		ur"""Format of Attribute2 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	@property
	def attribute3(self) :
		ur"""Name of attribute3 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute3expr(self) :
		ur"""Expression that will be evaluated to obtain attribute3's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute3friendlyname(self) :
		ur"""User-Friendly Name of attribute3 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute3format(self) :
		ur"""Format of Attribute3 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	@property
	def attribute4(self) :
		ur"""Name of attribute4 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute4expr(self) :
		ur"""Expression that will be evaluated to obtain attribute4's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute4friendlyname(self) :
		ur"""User-Friendly Name of attribute4 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute4format(self) :
		ur"""Format of Attribute4 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	@property
	def attribute5(self) :
		ur"""Name of attribute5 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute5expr(self) :
		ur"""Expression that will be evaluated to obtain attribute5's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute5friendlyname(self) :
		ur"""User-Friendly Name of attribute5 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute5format(self) :
		ur"""Format of Attribute5 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	@property
	def attribute6(self) :
		ur"""Name of attribute6 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute6expr(self) :
		ur"""Expression that will be evaluated to obtain attribute6's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute6friendlyname(self) :
		ur"""User-Friendly Name of attribute6 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute6format(self) :
		ur"""Format of Attribute6 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	@property
	def attribute7(self) :
		ur"""Name of attribute7 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute7expr(self) :
		ur"""Expression that will be evaluated to obtain attribute7's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute7friendlyname(self) :
		ur"""User-Friendly Name of attribute7 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute7format(self) :
		ur"""Format of Attribute7 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	@property
	def attribute8(self) :
		ur"""Name of attribute8 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute8expr(self) :
		ur"""Expression that will be evaluated to obtain attribute8's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute8friendlyname(self) :
		ur"""User-Friendly Name of attribute8 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute8format(self) :
		ur"""Format of Attribute8 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	@property
	def attribute9(self) :
		ur"""Name of attribute9 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute9expr(self) :
		ur"""Expression that will be evaluated to obtain attribute9's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute9friendlyname(self) :
		ur"""User-Friendly Name of attribute9 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute9format(self) :
		ur"""Format of Attribute9 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	def attribute10(self) :
		ur"""Name of attribute10 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute10expr(self) :
		ur"""Expression that will be evaluated to obtain attribute10's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute10friendlyname(self) :
		ur"""User-Friendly Name of attribute10 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute10format(self) :
		ur"""Format of Attribute10 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	def attribute11(self) :
		ur"""Name of attribute11 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute11expr(self) :
		ur"""Expression that will be evaluated to obtain attribute11's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute11friendlyname(self) :
		ur"""User-Friendly Name of attribute11 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute11format(self) :
		ur"""Format of Attribute11 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	def attribute12(self) :
		ur"""Name of attribute12 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute12expr(self) :
		ur"""Expression that will be evaluated to obtain attribute12's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute12friendlyname(self) :
		ur"""User-Friendly Name of attribute12 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute12format(self) :
		ur"""Format of Attribute12 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	def attribute13(self) :
		ur"""Name of attribute13 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute13expr(self) :
		ur"""Expression that will be evaluated to obtain attribute13's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute13friendlyname(self) :
		ur"""User-Friendly Name of attribute13 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute13format(self) :
		ur"""Format of Attribute13 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	def attribute14(self) :
		ur"""Name of attribute14 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute14expr(self) :
		ur"""Expression that will be evaluated to obtain attribute14's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute14friendlyname(self) :
		ur"""User-Friendly Name of attribute14 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute14format(self) :
		ur"""Format of Attribute14 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	def attribute15(self) :
		ur"""Name of attribute15 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute15expr(self) :
		ur"""Expression that will be evaluated to obtain attribute15's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute15friendlyname(self) :
		ur"""User-Friendly Name of attribute15 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute15format(self) :
		ur"""Format of Attribute15 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	def attribute16(self) :
		ur"""Name of attribute16 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute16expr(self) :
		ur"""Expression that will be evaluated to obtain attribute16's value to be sent in Assertion.<br/>Maximum length =  128.
		"""
		try :
	...
	def attribute16friendlyname(self) :
		ur"""User-Friendly Name of attribute16 that needs to be sent in SAML Assertion.
		"""
		try :
	...
	def attribute16format(self) :
		ur"""Format of Attribute16 to be sent in Assertion.<br/>Possible values = URI, Basic.
		"""
		try :
	...
	def encryptassertion(self) :
		ur"""Option to encrypt assertion when Netscaler IDP sends one.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def encryptionalgorithm(self) :
		ur"""Algorithm to be used to encrypt SAML assertion.<br/>Default value: AES256<br/>Possible values = DES3, AES128, AES192, AES256.
		"""
		try :
	...
	def samlbinding(self) :
		ur"""This element specifies the transport mechanism of saml messages.<br/>Default value: POST<br/>Possible values = REDIRECT, POST, ARTIFACT.
		"""
		try :
	...
	@property
	def skewtime(self) :
		ur"""This option specifies the number of minutes on either side of current time that the assertion would be valid. For example, if skewTime is 10, then assertion would be valid from (current time - 10) min to (current time + 10) min, ie 20min in all.<br/>Default value: 5.
		"""
		try :
	...
	def serviceproviderid(self) :
		ur"""Unique identifier of the Service Provider that sends SAML Request. Netscaler will ensure that the Issuer of the SAML Request matches this URI.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add authenticationsamlidpprofile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete authenticationsamlidpprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update authenticationsamlidpprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of authenticationsamlidpprofile resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the authenticationsamlidpprofile resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of authenticationsamlidpprofile resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the authenticationsamlidpprofile resources configured on NetScaler.
		"""
		try :
			obj = authenticationsamlidpprofile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of authenticationsamlidpprofile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationsamlidpprofile()
