...
class auditsyslogaction(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name of the syslog action. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the syslog action is added.
	...
	@property
	def serverip(self) :
		ur"""IP address of the syslog server.<br/>Minimum length =  1.
		"""
		try :
	...
	def serverdomainname(self) :
		ur"""SYSLOG server name as a FQDN.  Mutually exclusive with serverIP/lbVserverName.<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
	...
	def domainresolveretry(self) :
		ur"""Time, in seconds, for which the NetScaler appliance waits before sending another DNS query to resolve the host name of the syslog server if the last query failed.<br/>Default value: 5<br/>Minimum length =  5<br/>Maximum length =  20939.
		"""
		try :
	...
	def lbvservername(self) :
		ur"""Name of the LB vserver. Mutually exclusive with syslog serverIP/serverName.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	@property
	def serverport(self) :
		ur"""Port on which the syslog server accepts connections.<br/>Minimum length =  1.
		"""
		try :
	...
	def userdefinedauditlog(self) :
		ur"""Log user-configurable log messages to syslog. 
	...
	@property
	def lsn(self) :
		ur"""Log lsn info.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._lsn
		except Exception as e:
	...
	@property
	def alg(self) :
		ur"""Log alg info.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._alg
		except Exception as e:
	...
	def subscriberlog(self) :
		ur"""Log subscriber session event information.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def transport(self) :
		ur"""Transport type used to send auditlogs to syslog server. Default type is UDP.<br/>Possible values = TCP, UDP.
		"""
		try :
	...
	def tcpprofilename(self) :
		ur"""Name of the TCP profile whose settings are to be applied to the audit server info to tune the TCP connection parameters.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def maxlogdatasizetohold(self) :
		ur"""Max size of log data that can be held in NSB chain of server info.<br/>Default value: 500<br/>Minimum length =  50<br/>Maximum length =  25600.
		"""
		try :
	...
	@property
	def dns(self) :
		ur"""Log DNS related syslog messages.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._dns
		except Exception as e:
	...
	@property
	def netprofile(self) :
		ur"""Name of the network profile.
	...
	@property
	def ip(self) :
		ur"""The resolved IP address of the syslog server.
		"""
		try :
			return self._ip
		except Exception as e:
	...
	def add(cls, client, resource) :
		ur""" Use this API to add auditsyslogaction.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete auditsyslogaction.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update auditsyslogaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of auditsyslogaction resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the auditsyslogaction resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of auditsyslogaction resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the auditsyslogaction resources configured on NetScaler.
		"""
		try :
			obj = auditsyslogaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of auditsyslogaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = auditsyslogaction()
