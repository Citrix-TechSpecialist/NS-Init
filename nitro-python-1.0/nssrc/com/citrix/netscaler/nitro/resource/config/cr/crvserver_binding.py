...
class crvserver_binding(base_resource):
	...
	def crvserver_spilloverpolicy_bindings(self) :
		ur"""spilloverpolicy that can be bound to crvserver.
		"""
		try :
	...
	def crvserver_cachepolicy_bindings(self) :
		ur"""cachepolicy that can be bound to crvserver.
		"""
		try :
	...
	def crvserver_appfwpolicy_bindings(self) :
		ur"""appfwpolicy that can be bound to crvserver.
		"""
		try :
	...
	def crvserver_appflowpolicy_bindings(self) :
		ur"""appflowpolicy that can be bound to crvserver.
		"""
		try :
	...
	def crvserver_icapolicy_bindings(self) :
		ur"""icapolicy that can be bound to crvserver.
		"""
		try :
	...
	def crvserver_responderpolicy_bindings(self) :
		ur"""responderpolicy that can be bound to crvserver.
		"""
		try :
	...
	def crvserver_feopolicy_bindings(self) :
		ur"""feopolicy that can be bound to crvserver.
		"""
		try :
	...
	def crvserver_rewritepolicy_bindings(self) :
		ur"""rewritepolicy that can be bound to crvserver.
		"""
		try :
