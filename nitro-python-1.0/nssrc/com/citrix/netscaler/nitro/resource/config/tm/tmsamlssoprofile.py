...
class tmsamlssoprofile(base_resource) :
	...
	def samlsigningcertname(self) :
		ur"""Name of the SSL certificate that is used to Sign Assertion.<br/>Minimum length =  1.
		"""
		try :
	...
	def encryptassertion(self) :
		ur"""Option to encrypt assertion when Netscaler sends one.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def samlspcertname(self) :
		ur"""Name of the SSL certificate of peer/receving party using which Assertion is encrypted.<br/>Minimum length =  1.
		"""
		try :
