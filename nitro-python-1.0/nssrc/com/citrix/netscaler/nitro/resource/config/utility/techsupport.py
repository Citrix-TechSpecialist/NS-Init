...
class techsupport(base_resource) :
	...
	@property
	def response(self) :
		ur"""Output as text printed to console and syslog at NOTICE level.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the techsupport resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = techsupport()
