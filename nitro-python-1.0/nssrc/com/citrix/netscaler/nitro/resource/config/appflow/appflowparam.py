...
class appflowparam(base_resource) :
	...
	def securityinsightrecordinterval(self) :
		ur"""Interval, in seconds, at which to send security insight flow records to the configured collectors.<br/>Default value: 60<br/>Minimum length =  60<br/>Maximum length =  3600.
		"""
		try :
	...
	def identifiername(self) :
		ur"""Include the stream identifier name to be exported.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def identifiersessionname(self) :
		ur"""Include the stream identifier session name to be exported.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def observationdomainid(self) :
		ur"""An observation domain groups a set of NetScalers based on deployment: cluster, HA etc. A unique Observation Domain ID is required to be assigned to each such group.<br/>Default value: 0<br/>Minimum length =  1000.
		"""
		try :
	...
	def observationdomainname(self) :
		ur"""Name of the Observation Domain defined by the observation domain ID.<br/>Maximum length =  127.
		"""
		try :
	...
	def securityinsighttraffic(self) :
		ur"""Flag to determine whether security insight traffic needs to be exported or not.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def builtin(self) :
		ur"""Flag to determine if the appflow param is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
