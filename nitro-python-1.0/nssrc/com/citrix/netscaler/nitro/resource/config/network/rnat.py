...
class rnat(base_resource) :
	...
	@property
	def ownergroup(self) :
		ur"""The owner node group in a Cluster for this rnat rule.<br/>Default value: DEFAULT_NG<br/>Minimum length =  1.
		"""
		try :
	...
	def useproxyport(self) :
		ur"""Enable source port proxying, which enables the NetScaler appliance to use the RNAT ips using proxied source port.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def connfailover(self) :
		ur"""Synchronize connection information with the secondary appliance in a high availability (HA) pair. That is, synchronize all connection-related information for the RNAT session. In order for this to work, tcpproxy should be DISABLED. To disable tcpproxy use "set rnatparam tcpproxy DISABLED".<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
