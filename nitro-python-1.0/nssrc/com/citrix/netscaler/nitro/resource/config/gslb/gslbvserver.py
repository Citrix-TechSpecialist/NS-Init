...
class gslbvserver(base_resource) :
	...
	def servicetype(self) :
		ur"""Protocol used by services bound to the virtual server.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, NNTP, ANY, SIP_UDP, SIP_TCP, SIP_SSL, RADIUS, RDP, RTSP, MYSQL, MSSQL, ORACLE.
		"""
		try :
	...
	def dnsrecordtype(self) :
		ur"""DNS record type to associate with the GSLB virtual server's domain name.<br/>Default value: A<br/>Possible values = A, AAAA, CNAME, NAPTR.
		"""
		try :
