...
class aaagroup_vpntrafficpolicy_binding(base_resource) :
	...
	def get(cls, service, groupname) :
		ur""" Use this API to fetch aaagroup_vpntrafficpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to fetch filtered set of aaagroup_vpntrafficpolicy_binding resources.
	...
	def count(cls, service, groupname) :
		ur""" Use this API to count aaagroup_vpntrafficpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = aaagroup_vpntrafficpolicy_binding()
			obj.groupname = groupname
	...
	def count_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to count the filtered set of aaagroup_vpntrafficpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = aaagroup_vpntrafficpolicy_binding()
