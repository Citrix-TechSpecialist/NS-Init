...
class authenticationldapaction(base_resource) :
	...
	def __init__(self) :
		...
		self._referraldnslookup = ""
		self._mssrvrecordlocation = ""
	...
	def referraldnslookup(self) :
		ur"""Specifies the DNS Record lookup Type for the referrals.<br/>Default value: A-REC<br/>Possible values = A-REC, SRV-REC, MSSRV-REC.
		"""
		try :
	...
	def mssrvrecordlocation(self) :
		ur"""MSSRV Specific parameter. Used to locate the DNS node to which the SRV record pertains in the domainname. The domainname is appended to it to form the srv record.
	...
	@property
	def attribute1(self) :
		ur"""Expression that would be evaluated to extract attribute1 from the ldap response.
		"""
		try :
	...
	@property
	def attribute2(self) :
		ur"""Expression that would be evaluated to extract attribute2 from the ldap response.
		"""
		try :
	...
	@property
	def attribute3(self) :
		ur"""Expression that would be evaluated to extract attribute3 from the ldap response.
		"""
		try :
	...
	@property
	def attribute4(self) :
		ur"""Expression that would be evaluated to extract attribute4 from the ldap response.
		"""
		try :
	...
	@property
	def attribute5(self) :
		ur"""Expression that would be evaluated to extract attribute5 from the ldap response.
		"""
		try :
	...
	@property
	def attribute6(self) :
		ur"""Expression that would be evaluated to extract attribute6 from the ldap response.
		"""
		try :
	...
	@property
	def attribute7(self) :
		ur"""Expression that would be evaluated to extract attribute7 from the ldap response.
		"""
		try :
	...
	@property
	def attribute8(self) :
		ur"""Expression that would be evaluated to extract attribute8 from the ldap response.
		"""
		try :
	...
	@property
	def attribute9(self) :
		ur"""Expression that would be evaluated to extract attribute9 from the ldap response.
		"""
		try :
	...
	def attribute10(self) :
		ur"""Expression that would be evaluated to extract attribute10 from the ldap response.
		"""
		try :
	...
	def attribute11(self) :
		ur"""Expression that would be evaluated to extract attribute11 from the ldap response.
		"""
		try :
	...
	def attribute12(self) :
		ur"""Expression that would be evaluated to extract attribute12 from the ldap response.
		"""
		try :
	...
	def attribute13(self) :
		ur"""Expression that would be evaluated to extract attribute13 from the ldap response.
		"""
		try :
	...
	def attribute14(self) :
		ur"""Expression that would be evaluated to extract attribute14 from the ldap response.
		"""
		try :
	...
	def attribute15(self) :
		ur"""Expression that would be evaluated to extract attribute15 from the ldap response.
		"""
		try :
	...
	def attribute16(self) :
		ur"""Expression that would be evaluated to extract attribute16 from the ldap response.
		"""
		try :
