...
class authenticationsamlaction(base_resource) :
	...
	@property
	def attribute1(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute1.
		"""
		try :
	...
	@property
	def attribute2(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute2.
		"""
		try :
	...
	@property
	def attribute3(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute3.
		"""
		try :
	...
	@property
	def attribute4(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute4.
		"""
		try :
	...
	@property
	def attribute5(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute5.
		"""
		try :
	...
	@property
	def attribute6(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute6.
		"""
		try :
	...
	@property
	def attribute7(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute7.
		"""
		try :
	...
	@property
	def attribute8(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute8.
		"""
		try :
	...
	@property
	def attribute9(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute9.
		"""
		try :
	...
	def attribute10(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute10.
		"""
		try :
	...
	def attribute11(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute11.
		"""
		try :
	...
	def attribute12(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute12.
		"""
		try :
	...
	def attribute13(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute13.
		"""
		try :
	...
	def attribute14(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute14.
		"""
		try :
	...
	def attribute15(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute15.
		"""
		try :
	...
	def attribute16(self) :
		ur"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute16.
		"""
		try :
	...
	def enforceusername(self) :
		ur"""Option to choose whether the username that is extracted from SAML assertion can be edited in login page while doing second factor.<br/>Default value: ON<br/>Possible values = ON, OFF.
		"""
		try :
	...
	@property
	def logouturl(self) :
		ur"""SingleLogout URL on IdP to which logoutRequest will be sent on Netscaler session cleanup.
		"""
		try :
	...
	def artifactresolutionserviceurl(self) :
		ur"""URL of the Artifact Resolution Service on IdP to which Netscaler will post artifact to get actual SAML token.
		"""
		try :
	...
	@property
	def skewtime(self) :
		ur"""This option specifies the allowed clock skew in number of minutes that Netscaler ServiceProvider allows on an incoming assertion. For example, if skewTime is 10, then assertion would be valid from (current time - 10) min to (current time + 10) min, ie 20min in all.<br/>Default value: 5.
		"""
		try :
