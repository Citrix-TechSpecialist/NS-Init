...
class clusternodegroup(base_resource) :
	...
	@property
	def state(self) :
		ur"""State of the nodegroup. All the nodes binding to this nodegroup must have the same state. ACTIVE/SPARE/PASSIVE.<br/>Possible values = ACTIVE, SPARE, PASSIVE.
		"""
		try :
			return self._state
		except Exception as e:
	...
	@property
	def priority(self) :
		ur"""Priority of Nodegroup. This priority is used for all the nodes bound to the nodegroup for Nodegroup selection.<br/>Maximum length =  31.
		"""
		try :
