...
class transformpolicy_binding(base_resource):
	...
	def transformpolicy_transformglobal_bindings(self) :
		ur"""transformglobal that can be bound to transformpolicy.
		"""
		try :
	...
	def transformpolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to transformpolicy.
		"""
		try :
	...
	def transformpolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to transformpolicy.
		"""
		try :
	...
	def transformpolicy_transformpolicylabel_bindings(self) :
		ur"""transformpolicylabel that can be bound to transformpolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch transformpolicy_binding resource.
		"""
		try :
