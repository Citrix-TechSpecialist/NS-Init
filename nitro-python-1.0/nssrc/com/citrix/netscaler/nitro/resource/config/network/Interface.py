...
class Interface(base_resource) :
	...
	@property
	def duplex(self) :
		ur"""The duplex mode for the interface. Notes:* If you set the duplex mode to AUTO, the NetScaler appliance attempts to auto-negotiate the duplex mode of the interface when it is UP. You must enable auto negotiation on the interface. If you set a duplex mode other than AUTO, you must specify the same duplex mode for the peer network device. Mismatched speed and duplex settings between the peer devices of a link lead to link errors, packet loss, and other errors.<br/>Default value: AUTO<br/>Possible values = AUTO, HALF, FULL.
		"""
		try :
			return self._duplex
		except Exception as e:
	...
	def lrsetpriority(self) :
		ur"""LRSET port priority, expressed as an integer ranging from 1 to 1024. The highest priority is 1. The NetScaler limits the number of interfaces in an LRSET to 8. Within a LRSET the highest LR Priority Interface is considered as the first candidate for the Active interface, if the interface is UP.<br/>Default value: 1024<br/>Minimum length =  1<br/>Maximum length =  1024.
		"""
		try :
	...
	@property
	def reqspeed(self) :
		ur"""Requested speed setting for this interface.<br/>Possible values = AUTO, 10, 100, 1000, 10000, 40000.
		"""
		try :
	...
	@property
	def actspeed(self) :
		ur"""Actual speed setting for this interface.<br/>Possible values = AUTO, 10, 100, 1000, 10000, 40000.
		"""
		try :
	...
	def lractiveintf(self) :
		ur"""LR set member interface state(active/inactive).
		"""
		try :
