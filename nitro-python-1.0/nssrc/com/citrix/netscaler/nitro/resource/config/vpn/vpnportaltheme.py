...
class vpnportaltheme(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name of the uitheme.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def basetheme(self) :
		ur""".<br/>Minimum length =  1<br/>Possible values = Default, Greenbubble, X1.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add vpnportaltheme.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete vpnportaltheme.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the vpnportaltheme resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = vpnportaltheme()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of vpnportaltheme resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the vpnportaltheme resources configured on NetScaler.
		"""
		try :
			obj = vpnportaltheme()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of vpnportaltheme resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnportaltheme()
