...
class aaauser_intranetip_binding(base_resource) :
	...
	@property
	def intranetip(self) :
		ur"""The Intranet IP bound to the user.
		"""
		try :
	...
	def get(cls, service, username) :
		ur""" Use this API to fetch aaauser_intranetip_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, username, filter_) :
		ur""" Use this API to fetch filtered set of aaauser_intranetip_binding resources.
	...
	def count(cls, service, username) :
		ur""" Use this API to count aaauser_intranetip_binding resources configued on NetScaler.
		"""
		try :
			obj = aaauser_intranetip_binding()
			obj.username = username
	...
	def count_filtered(cls, service, username, filter_) :
		ur""" Use this API to count the filtered set of aaauser_intranetip_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = aaauser_intranetip_binding()
