...
class iptunnel(base_resource) :
	...
	@property
	def grepayload(self) :
		ur"""The payload GRE will carry.<br/>Default value: ETHERNETwithDOT1Q<br/>Possible values = ETHERNETwithDOT1Q, ETHERNET, IP.
		"""
		try :
	...
	@property
	def ownergroup(self) :
		ur"""The owner node group in a Cluster for the iptunnel.<br/>Default value: DEFAULT_NG<br/>Minimum length =  1.
		"""
		try :
