...
class appfwprofile_sqlinjection_binding(base_resource) :
	...
	def as_value_expr_sql(self) :
		ur"""The web form value expression.
		"""
		try :
	...
	def isvalueregex_sql(self) :
		ur"""Is the web form field value a regular expression?.<br/>Possible values = REGEX, NOTREGEX.
		"""
		try :
	...
	def as_value_type_sql(self) :
		ur"""The web form value type.<br/>Possible values = Keyword, SpecialString, Wildchar.
		"""
		try :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch appfwprofile_sqlinjection_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of appfwprofile_sqlinjection_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count appfwprofile_sqlinjection_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_sqlinjection_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of appfwprofile_sqlinjection_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_sqlinjection_binding()
