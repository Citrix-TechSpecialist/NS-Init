...
class locationfile6(base_resource) :
	...
	def Locationfile(self) :
		ur"""Name of the IPv6 location file, with or without absolute path. If the path is not included, the default path (/var/netscaler/locdb) is assumed. In a high availability setup, the static database must be stored in the same location on both NetScaler appliances.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def format(self) :
		ur"""Format of the IPv6 location file. Required for the NetScaler appliance to identify how to read the location file.<br/>Default value: netscaler6<br/>Possible values = netscaler6, geoip-country6.
		"""
		try :
			return self._format
		except Exception as e:
	...
	@property
	def src(self) :
		ur"""URL \(protocol, host, path, and file name\) from where the location file will be imported.
	...
	def add(cls, client, resource) :
		ur""" Use this API to add locationfile6.
		"""
		try :
	...
	def delete(cls, client, resource="") :
		ur""" Use this API to delete locationfile6.
		"""
		try :
			if type(resource) is not list :
	...
	def Import(cls, client, resource) :
		ur""" Use this API to Import locationfile6.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the locationfile6 resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = locationfile6()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of locationfile6 resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the locationfile6 resources configured on NetScaler.
		"""
		try :
			obj = locationfile6()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of locationfile6 resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = locationfile6()
