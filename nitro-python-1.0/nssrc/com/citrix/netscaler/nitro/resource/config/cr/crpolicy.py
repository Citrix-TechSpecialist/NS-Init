...
class crpolicy(base_resource) :
	...
	@property
	def action(self) :
		ur"""Name of the built-in cache redirection action: CACHE/ORIGIN.
		"""
		try :
			return self._action
		except Exception as e:
	...
	@property
	def logaction(self) :
		ur"""The log action associated with the cache redirection policy.
		"""
		try :
	...
	@property
	def isdefault(self) :
		ur"""A value of true is returned if it is a default cr policy.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of crpolicy resource.
	...
	def rename(cls, client, resource, new_policyname) :
		ur""" Use this API to rename a crpolicy resource.
		"""
		try :
