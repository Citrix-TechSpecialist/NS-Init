...
class sslservicegroup_ecccurve_binding(base_resource) :
	...
	def ecccurvename(self) :
		ur"""Named ECC curve bound to servicegroup.<br/>Possible values = ALL, P_224, P_256, P_384, P_521.
		"""
		try :
	...
	def get(cls, service, servicegroupname) :
		ur""" Use this API to fetch sslservicegroup_ecccurve_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, servicegroupname, filter_) :
		ur""" Use this API to fetch filtered set of sslservicegroup_ecccurve_binding resources.
	...
	def count(cls, service, servicegroupname) :
		ur""" Use this API to count sslservicegroup_ecccurve_binding resources configued on NetScaler.
		"""
		try :
			obj = sslservicegroup_ecccurve_binding()
			obj.servicegroupname = servicegroupname
	...
	def count_filtered(cls, service, servicegroupname, filter_) :
		ur""" Use this API to count the filtered set of sslservicegroup_ecccurve_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslservicegroup_ecccurve_binding()
