...
class sslservicegroup_binding(base_resource):
	...
	def servicegroupname(self) :
		ur"""Name of the SSL service group for which to show detailed information.<br/>Minimum length =  1.
		"""
		try :
	...
	def sslservicegroup_sslcipher_bindings(self) :
		ur"""sslcipher that can be bound to sslservicegroup.
		"""
		try :
	...
	def sslservicegroup_sslciphersuite_bindings(self) :
		ur"""sslciphersuite that can be bound to sslservicegroup.
		"""
		try :
	...
	def sslservicegroup_ecccurve_bindings(self) :
		ur"""ecccurve that can be bound to sslservicegroup.
		"""
		try :
	...
	def sslservicegroup_sslcertkey_bindings(self) :
		ur"""sslcertkey that can be bound to sslservicegroup.
		"""
		try :
	...
	def get(self, service, servicegroupname) :
		ur""" Use this API to fetch sslservicegroup_binding resource.
		"""
		try :
