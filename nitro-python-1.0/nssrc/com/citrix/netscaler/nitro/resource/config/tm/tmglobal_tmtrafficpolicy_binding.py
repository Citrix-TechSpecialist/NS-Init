...
class tmglobal_tmtrafficpolicy_binding(base_resource) :
	...
	def globalbindtype(self) :
		ur""".<br/>Default value: SYSTEM_GLOBAL<br/>Possible values = SYSTEM_GLOBAL, VPN_GLOBAL, RNAT_GLOBAL.
		"""
		try :
	...
	def gotopriorityexpression(self) :
		ur"""Applicable only to advance tmsession policy. Expression or other value specifying the next policy to be evaluated if the current policy evaluates to TRUE.  Specify one of the following values:
	...
	@property
	def type(self) :
		ur"""Bindpoint to which the policy is bound.<br/>Possible values = REQ_OVERRIDE, REQ_DEFAULT, RES_OVERRIDE, RES_DEFAULT.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a tmglobal_tmtrafficpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		ur""" Use this API to fetch filtered set of tmglobal_tmtrafficpolicy_binding resources.
	...
	def count(cls, service) :
		ur""" Use this API to count tmglobal_tmtrafficpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = tmglobal_tmtrafficpolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of tmglobal_tmtrafficpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = tmglobal_tmtrafficpolicy_binding()
