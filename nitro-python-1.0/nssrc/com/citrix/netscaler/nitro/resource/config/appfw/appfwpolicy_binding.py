...
class appfwpolicy_binding(base_resource):
	...
	def appfwpolicy_appfwpolicylabel_bindings(self) :
		ur"""appfwpolicylabel that can be bound to appfwpolicy.
		"""
		try :
	...
	def appfwpolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to appfwpolicy.
		"""
		try :
	...
	def appfwpolicy_appfwglobal_bindings(self) :
		ur"""appfwglobal that can be bound to appfwpolicy.
		"""
		try :
	...
	def appfwpolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to appfwpolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch appfwpolicy_binding resource.
		"""
		try :
