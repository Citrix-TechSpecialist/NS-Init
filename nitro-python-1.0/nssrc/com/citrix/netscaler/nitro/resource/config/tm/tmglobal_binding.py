...
class tmglobal_binding(base_resource):
	...
	def tmglobal_tmtrafficpolicy_bindings(self) :
		ur"""tmtrafficpolicy that can be bound to tmglobal.
		"""
		try :
	...
	def tmglobal_auditnslogpolicy_bindings(self) :
		ur"""auditnslogpolicy that can be bound to tmglobal.
		"""
		try :
	...
	def tmglobal_auditsyslogpolicy_bindings(self) :
		ur"""auditsyslogpolicy that can be bound to tmglobal.
		"""
		try :
	...
	def tmglobal_tmsessionpolicy_bindings(self) :
		ur"""tmsessionpolicy that can be bound to tmglobal.
		"""
		try :
	...
	def get(self, service) :
		ur""" Use this API to fetch a tmglobal_binding resource .
		"""
		try :
