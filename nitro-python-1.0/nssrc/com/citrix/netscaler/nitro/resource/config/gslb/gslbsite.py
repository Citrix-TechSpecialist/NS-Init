...
class gslbsite(base_resource) :
	...
	@property
	def clip(self) :
		ur"""Cluster IP address. Specify this parameter to connect to the remote cluster site for GSLB auto-sync. Note: The cluster IP address is defined when creating the cluster.
		"""
		try :
			return self._clip
		except Exception as e:
	...
	@property
	def publicclip(self) :
		ur"""IP address to be used to globally access the remote cluster when it is deployed behind a NAT. It can be same as the normal cluster IP address.
		"""
		try :
	...
	def naptrreplacementsuffix(self) :
		ur"""The naptr replacement suffix configured here will be used to construct the naptr replacement field in NAPTR record.<br/>Minimum length =  1.
		"""
		try :
