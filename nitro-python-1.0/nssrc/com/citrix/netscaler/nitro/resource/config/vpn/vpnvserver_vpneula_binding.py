...
class vpnvserver_vpneula_binding(base_resource) :
	...
	@property
	def eula(self) :
		ur"""Name of the EULA bound to VPN vserver.
		"""
		try :
			return self._eula
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch vpnvserver_vpneula_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of vpnvserver_vpneula_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count vpnvserver_vpneula_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnvserver_vpneula_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of vpnvserver_vpneula_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnvserver_vpneula_binding()
