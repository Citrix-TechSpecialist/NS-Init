...
class l3param(base_resource) :
	...
	def overridelsn(self) :
		ur"""USNIP/USIP settings override LSN settings for configured
		service/virtual server traffic.. .<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def dynamicrouting(self) :
		ur"""Enable/Disable Dynamic routing on partition.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
