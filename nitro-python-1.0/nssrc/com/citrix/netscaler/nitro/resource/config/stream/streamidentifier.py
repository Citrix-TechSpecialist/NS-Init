...
class streamidentifier(base_resource) :
	...
	@property
	def snmptrap(self) :
		ur"""Enable/disable SNMP trap for stream identifier.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def appflowlog(self) :
		ur"""Enable/disable Appflow logging for stream identifier.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def tracktransactions(self) :
		ur"""Track transactions exceeding configured threshold. Transaction tracking can be enabled for following metric: ResponseTime.
	...
	def maxtransactionthreshold(self) :
		ur"""Maximum per transcation value of metric. Metric to be tracked is specified by tracktransactions attribute.<br/>Default value: 0.
		"""
		try :
	...
	def mintransactionthreshold(self) :
		ur"""Minimum per transcation value of metric. Metric to be tracked is specified by tracktransactions attribute.<br/>Default value: 0.
		"""
		try :
	...
	def acceptancethreshold(self) :
		ur"""Non-Breaching transactions to Total transactions threshold expressed in percent.
	...
	def breachthreshold(self) :
		ur"""Breaching transactions threshold calculated over interval.<br/>Default value: 0.
		"""
		try :
