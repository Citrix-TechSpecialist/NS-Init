...
class dnspolicy(base_resource) :
	...
	@property
	def builtin(self) :
		ur"""Flag to determine whether DNS policy is default or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of dnspolicy resource.
