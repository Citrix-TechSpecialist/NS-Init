...
class route6(base_resource) :
	...
	@property
	def vxlan(self) :
		ur"""Integer value that uniquely identifies a VXLAN through which the NetScaler appliance forwards the packets for this route.<br/>Minimum length =  1<br/>Maximum length =  16777215.
		"""
		try :
			return self._vxlan
		except Exception as e:
	...
	@property
	def msr(self) :
		ur"""Monitor this route with a monitor of type ND6 or PING.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._msr
		except Exception as e:
	...
	@property
	def ownergroup(self) :
		ur"""The owner node group in a Cluster for this route6. If owner node group is not specified then the route is treated as Striped route.<br/>Default value: DEFAULT_NG<br/>Minimum length =  1.
		"""
		try :
