...
class vpnvserver_vpnportaltheme_binding(base_resource) :
	...
	def portaltheme(self) :
		ur"""Name of the portal theme bound to VPN vserver.
		"""
		try :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch vpnvserver_vpnportaltheme_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of vpnvserver_vpnportaltheme_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count vpnvserver_vpnportaltheme_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnvserver_vpnportaltheme_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of vpnvserver_vpnportaltheme_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnvserver_vpnportaltheme_binding()
