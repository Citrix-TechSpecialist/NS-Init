...
class systemglobal_authenticationradiuspolicy_binding(base_resource) :
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a systemglobal_authenticationradiuspolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		ur""" Use this API to fetch filtered set of systemglobal_authenticationradiuspolicy_binding resources.
	...
	def count(cls, service) :
		ur""" Use this API to count systemglobal_authenticationradiuspolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = systemglobal_authenticationradiuspolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of systemglobal_authenticationradiuspolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = systemglobal_authenticationradiuspolicy_binding()
