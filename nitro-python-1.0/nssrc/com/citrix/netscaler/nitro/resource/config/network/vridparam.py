...
class vridparam(base_resource) :
	...
	def hellointerval(self) :
		ur"""Interval, in milliseconds, between vrrp advertisement messages sent to the peer node in active-active mode.<br/>Default value: 1000<br/>Minimum length =  200<br/>Maximum length =  1000.
		"""
		try :
	...
	def deadinterval(self) :
		ur"""Number of seconds after which a peer node in active-active mode is marked down if vrrp advertisements are not received from the peer node.<br/>Default value: 3<br/>Minimum length =  1<br/>Maximum length =  3.
		"""
		try :
