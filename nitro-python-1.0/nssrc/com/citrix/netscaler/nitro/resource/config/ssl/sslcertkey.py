...
class sslcertkey(base_resource) :
	...
	@property
	def hsmkey(self) :
		ur"""Name of the HSM key that was created in the External Hardware Security Module (HSM) of a FIPS appliance.<br/>Minimum length =  1.
		"""
		try :
			return self._hsmkey
		except Exception as e:
	...
	@property
	def inform(self) :
		ur"""Input format of the certificate and the private-key files. The three formats supported by the appliance are:
