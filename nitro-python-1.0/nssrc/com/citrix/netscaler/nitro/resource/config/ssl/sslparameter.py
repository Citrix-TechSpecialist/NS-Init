...
class sslparameter(base_resource) :
	...
	def __init__(self) :
		...
		self._svctls1112disable = ""
		self._montls1112disable = ""
	...
	def cryptodevdisablelimit(self) :
		ur"""Limit to the number of disabled SSL chips after which the ADC restarts. A value of zero implies that the ADC does not automatically restart.<br/>Default value: 0.
		"""
		try :
	...
	def defaultprofile(self) :
		ur"""Global parameter used to enable default profile feature.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def svctls1112disable(self) :
		ur"""Disable TLS 1.1 and 1.2 for dynamic and VPN created services.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def montls1112disable(self) :
		ur"""Disable TLS 1.1 and 1.2 for secure (https) monitors bound to SSL_BRIDGE services.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
