...
class appfwlearningsettings(base_resource) :
	...
	def __init__(self) :
		...
		self._creditcardnumberminthreshold = 0
		self._creditcardnumberpercentthreshold = 0
		self._contenttypeminthreshold = 0
		self._contenttypepercentthreshold = 0
	...
	def creditcardnumberminthreshold(self) :
		ur"""Minimum threshold to learn Credit Card information.<br/>Default value: 1<br/>Minimum length =  1.
		"""
		try :
	...
	def creditcardnumberpercentthreshold(self) :
		ur"""Minimum threshold in percent to learn Credit Card information.<br/>Default value: 0<br/>Maximum length =  100.
		"""
		try :
	...
	def contenttypeminthreshold(self) :
		ur"""Minimum threshold to learn Content Type information.<br/>Default value: 1<br/>Minimum length =  1.
		"""
		try :
	...
	def contenttypepercentthreshold(self) :
		ur"""Minimum threshold in percent to learn Content Type information.<br/>Default value: 0<br/>Maximum length =  100.
		"""
		try :
