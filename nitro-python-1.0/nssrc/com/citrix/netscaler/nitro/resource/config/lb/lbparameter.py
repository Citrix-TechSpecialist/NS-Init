...
class lbparameter(base_resource) :
	...
	def retainservicestate(self) :
		ur"""This option is used to retain the original state of service or servicegroup member when an enable server command is issued.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
