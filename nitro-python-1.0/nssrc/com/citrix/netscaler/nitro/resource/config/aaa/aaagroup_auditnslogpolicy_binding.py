...
class aaagroup_auditnslogpolicy_binding(base_resource) :
	...
	def get(cls, service, groupname) :
		ur""" Use this API to fetch aaagroup_auditnslogpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to fetch filtered set of aaagroup_auditnslogpolicy_binding resources.
	...
	def count(cls, service, groupname) :
		ur""" Use this API to count aaagroup_auditnslogpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = aaagroup_auditnslogpolicy_binding()
			obj.groupname = groupname
	...
	def count_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to count the filtered set of aaagroup_auditnslogpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = aaagroup_auditnslogpolicy_binding()
