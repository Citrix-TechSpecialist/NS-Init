...
class lsnrtspalgsession_datachannel_binding(base_resource) :
	...
	@classmethod
	def get(cls, service, sessionid) :
		ur""" Use this API to fetch lsnrtspalgsession_datachannel_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, sessionid, filter_) :
		ur""" Use this API to fetch filtered set of lsnrtspalgsession_datachannel_binding resources.
	...
	def count(cls, service, sessionid) :
		ur""" Use this API to count lsnrtspalgsession_datachannel_binding resources configued on NetScaler.
		"""
		try :
			obj = lsnrtspalgsession_datachannel_binding()
			obj.sessionid = sessionid
	...
	def count_filtered(cls, service, sessionid, filter_) :
		ur""" Use this API to count the filtered set of lsnrtspalgsession_datachannel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsnrtspalgsession_datachannel_binding()
