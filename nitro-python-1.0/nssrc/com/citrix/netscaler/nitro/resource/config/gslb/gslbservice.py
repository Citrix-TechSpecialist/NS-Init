...
class gslbservice(base_resource) :
	...
	def servicetype(self) :
		ur"""Type of service to create.<br/>Default value: NSSVC_SERVICE_UNKNOWN<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, NNTP, ANY, SIP_UDP, SIP_TCP, SIP_SSL, RADIUS, RDP, RTSP, MYSQL, MSSQL, ORACLE.
		"""
		try :
	...
	@property
	def naptrorder(self) :
		ur"""An integer specifying the order in which the NAPTR records MUST be processed in order to accurately represent the ordered list of Rules. The ordering is from lowest to highest.<br/>Default value: 1<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
	...
	def naptrdomainttl(self) :
		ur"""Modify the TTL of the internally created naptr domain.<br/>Default value: 3600<br/>Minimum length =  1.
		"""
		try :
	...
	def naptrpreference(self) :
		ur"""An integer specifying the preference of this NAPTR among NAPTR records having same order. lower the number, higher the preference.<br/>Default value: 1<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
