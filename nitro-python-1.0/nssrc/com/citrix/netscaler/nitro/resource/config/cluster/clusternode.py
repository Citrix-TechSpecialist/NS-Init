...
class clusternode(base_resource) :
	...
	@property
	def nodegroup(self) :
		ur"""The default node group in a Cluster system.<br/>Default value: DEFAULT_NG<br/>Minimum length =  1.
		"""
		try :
	...
	def clearnodegroupconfig(self) :
		ur"""Option to remove nodegroup config.<br/>Default value: YES<br/>Possible values = YES, NO.
		"""
		try :
	...
	@property
	def name(self) :
		ur"""Name of the state specific nodegroup.<br/>Minimum length =  1.
		"""
		try :
			return self._name
		except Exception as e:
	...
	@property
	def cfgflags(self) :
		ur"""Flag indicates whether the node is bound to cluster nodegroup.
		"""
		try :
