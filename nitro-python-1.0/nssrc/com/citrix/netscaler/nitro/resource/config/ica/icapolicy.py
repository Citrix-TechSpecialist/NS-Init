...
class icapolicy(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for the policy. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters.
	...
	@property
	def rule(self) :
		ur"""Expression or other value against which the traffic is evaluated. Must be a Boolean, default syntax expression.  Note: Maximum length of a string literal in the expression is 255 characters. A longer string can be split into smaller strings of up to 255 characters each, and the smaller strings concatenated with the + operator. For example, you can create a 500-character string as follows: '"<string of 255 characters>" + "<string of 245 characters>"'
	...
	@property
	def action(self) :
		ur"""Name of the ica action to be associated with this policy.
		"""
		try :
			return self._action
		except Exception as e:
	...
	@property
	def comment(self) :
		ur"""Any type of information about this ICA policy.
		"""
		try :
	...
	@property
	def newname(self) :
		ur"""New name for the policy. Must begin with an ASCII alphabetic or underscore (_)character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), s
	...
	@property
	def builtin(self) :
		ur"""Indicates that the ICA policy is a built-in (SYSTEM INTERNAL) type.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add icapolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete icapolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update icapolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of icapolicy resource.
	...
	def rename(cls, client, resource, new_name) :
		ur""" Use this API to rename a icapolicy resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the icapolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = icapolicy()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of icapolicy resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the icapolicy resources configured on NetScaler.
		"""
		try :
			obj = icapolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of icapolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = icapolicy()
