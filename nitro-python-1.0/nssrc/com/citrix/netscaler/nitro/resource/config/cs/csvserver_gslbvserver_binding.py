...
class csvserver_gslbvserver_binding(base_resource) :
	...
	@property
	def vserver(self) :
		ur"""Name of the default gslb or vpn vserver bound to CS vserver of type GSLB/VPN. For Example: bind cs vserver cs1 -vserver gslb1 or bind cs vserver cs1 -vserver vpn1.<br/>Minimum length =  1.
		"""
		try :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch csvserver_gslbvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of csvserver_gslbvserver_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count csvserver_gslbvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = csvserver_gslbvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of csvserver_gslbvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = csvserver_gslbvserver_binding()
