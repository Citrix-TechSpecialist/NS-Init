...
class lsnclient_network_binding(base_resource) :
	...
	def get(cls, service, clientname) :
		ur""" Use this API to fetch lsnclient_network_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, clientname, filter_) :
		ur""" Use this API to fetch filtered set of lsnclient_network_binding resources.
	...
	def count(cls, service, clientname) :
		ur""" Use this API to count lsnclient_network_binding resources configued on NetScaler.
		"""
		try :
			obj = lsnclient_network_binding()
			obj.clientname = clientname
	...
	def count_filtered(cls, service, clientname, filter_) :
		ur""" Use this API to count the filtered set of lsnclient_network_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsnclient_network_binding()
