...
class lsngroup_lsnhttphdrlogprofile_binding(base_resource) :
	...
	def httphdrlogprofilename(self) :
		ur"""The name of the LSN HTTP header logging Profile.
		"""
		try :
	...
	def get(cls, service, groupname) :
		ur""" Use this API to fetch lsngroup_lsnhttphdrlogprofile_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to fetch filtered set of lsngroup_lsnhttphdrlogprofile_binding resources.
	...
	def count(cls, service, groupname) :
		ur""" Use this API to count lsngroup_lsnhttphdrlogprofile_binding resources configued on NetScaler.
		"""
		try :
			obj = lsngroup_lsnhttphdrlogprofile_binding()
			obj.groupname = groupname
	...
	def count_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to count the filtered set of lsngroup_lsnhttphdrlogprofile_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsngroup_lsnhttphdrlogprofile_binding()
