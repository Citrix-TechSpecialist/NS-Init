...
class sslcipher_sslprofile_binding(base_resource) :
	...
	def cipherpriority(self) :
		ur"""Priority of the cipher to be added.<br/>Minimum value =  1<br/>Maximum value =  1000.
		"""
		try :
	...
	@property
	def sslprofile(self) :
		ur"""Name of the profile to which cipher is attached.
		"""
		try :
	...
	def get(cls, service, ciphergroupname) :
		ur""" Use this API to fetch sslcipher_sslprofile_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, ciphergroupname, filter_) :
		ur""" Use this API to fetch filtered set of sslcipher_sslprofile_binding resources.
	...
	def count(cls, service, ciphergroupname) :
		ur""" Use this API to count sslcipher_sslprofile_binding resources configued on NetScaler.
		"""
		try :
			obj = sslcipher_sslprofile_binding()
			obj.ciphergroupname = ciphergroupname
	...
	def count_filtered(cls, service, ciphergroupname, filter_) :
		ur""" Use this API to count the filtered set of sslcipher_sslprofile_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcipher_sslprofile_binding()
