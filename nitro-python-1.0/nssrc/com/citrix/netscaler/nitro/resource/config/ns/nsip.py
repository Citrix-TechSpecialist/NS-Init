...
class nsip(base_resource) :
	...
	def ospflsatype(self) :
		ur"""Type of LSAs to be used by the OSPF protocol, running on the NetScaler appliance, for advertising the route for this VIP address.<br/>Default value: TYPE5<br/>Possible values = TYPE1, TYPE5.
		"""
		try :
