...
class responderaction(base_resource) :
	...
	def responsestatuscode(self) :
		ur"""HTTP response status code, for example 200, 302, 404, etc. The default value for the redirect action type is 302 and for respondwithhtmlpage is 200.<br/>Minimum length =  100<br/>Maximum length =  599.
		"""
		try :
	...
	def reasonphrase(self) :
		ur"""Expression specifying the reason phrase of the HTTP response. The reason phrase may be a string literal with quotes or a PI expression. For example: "Invalid URL: " + HTTP.REQ.URL.
		"""
		try :
	...
	@property
	def builtin(self) :
		ur"""Flag to determine whether responder action is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
