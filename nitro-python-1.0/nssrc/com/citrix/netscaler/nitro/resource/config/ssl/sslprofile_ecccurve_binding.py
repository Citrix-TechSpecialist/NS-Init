...
class sslprofile_ecccurve_binding(base_resource) :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch sslprofile_ecccurve_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of sslprofile_ecccurve_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count sslprofile_ecccurve_binding resources configued on NetScaler.
		"""
		try :
			obj = sslprofile_ecccurve_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of sslprofile_ecccurve_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslprofile_ecccurve_binding()
