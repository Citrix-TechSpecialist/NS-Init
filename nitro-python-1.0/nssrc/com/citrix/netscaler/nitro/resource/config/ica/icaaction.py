...
class icaaction(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for the ICA action. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the ICA action is added.
	...
	def accessprofilename(self) :
		ur"""Name of the ica accessprofile to be associated with this action.
		"""
		try :
	...
	@property
	def newname(self) :
		ur"""New name for the ICA action. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#),period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters.
		The following requirement applies only to the NetScaler CLI:
		If the name includes one or more spaces, enclose the name in double or single quotation marks ( for example, "my ica action" or 'my ica action').<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def builtin(self) :
		ur"""Indicates that the ICA action is a built-in (SYSTEM INTERNAL) type.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
	...
	@property
	def isdefault(self) :
		ur"""A value of true is returned if it is a default action.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add icaaction.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete icaaction.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update icaaction.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_name) :
		ur""" Use this API to rename a icaaction resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the icaaction resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = icaaction()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of icaaction resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the icaaction resources configured on NetScaler.
		"""
		try :
			obj = icaaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of icaaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = icaaction()
