...
class appfwprofile_safeobject_binding(base_resource) :
	...
	def maxmatchlength(self) :
		ur"""Maximum match length for a Safe Object expression.
		"""
		try :
	...
	@property
	def expression(self) :
		ur"""A regular expression that defines the Safe Object.
		"""
		try :
	...
	@property
	def action(self) :
		ur"""Safe Object action types. (BLOCK | LOG | STATS | NONE).<br/>Possible values = none, block, log, remove, stats, xout.
		"""
		try :
			return self._action
		except Exception as e:
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch appfwprofile_safeobject_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of appfwprofile_safeobject_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count appfwprofile_safeobject_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_safeobject_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of appfwprofile_safeobject_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_safeobject_binding()
