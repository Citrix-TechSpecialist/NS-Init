...
class inat(base_resource) :
	...
	@property
	def usip(self) :
		ur"""Enable the NetScaler appliance to retain the source IP address of packets before sending the packets to the server.<br/>Possible values = ON, OFF.
		"""
		try :
			return self._usip
		except Exception as e:
	...
	@property
	def usnip(self) :
		ur"""Enable the NetScaler appliance to use a SNIP address as the source IP address of packets before sending the packets to the server.<br/>Possible values = ON, OFF.
		"""
		try :
			return self._usnip
		except Exception as e:
	...
	def useproxyport(self) :
		ur"""Enable the NetScaler appliance to proxy the source port of packets before sending the packets to the server.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
