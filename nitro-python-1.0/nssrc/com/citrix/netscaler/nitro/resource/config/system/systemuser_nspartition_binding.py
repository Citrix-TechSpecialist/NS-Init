...
class systemuser_nspartition_binding(base_resource) :
	...
	def partitionname(self) :
		ur"""Name of the Partition to bind to the system user.
		"""
		try :
	...
	def get(cls, service, username) :
		ur""" Use this API to fetch systemuser_nspartition_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, username, filter_) :
		ur""" Use this API to fetch filtered set of systemuser_nspartition_binding resources.
	...
	def count(cls, service, username) :
		ur""" Use this API to count systemuser_nspartition_binding resources configued on NetScaler.
		"""
		try :
			obj = systemuser_nspartition_binding()
			obj.username = username
	...
	def count_filtered(cls, service, username, filter_) :
		ur""" Use this API to count the filtered set of systemuser_nspartition_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = systemuser_nspartition_binding()
