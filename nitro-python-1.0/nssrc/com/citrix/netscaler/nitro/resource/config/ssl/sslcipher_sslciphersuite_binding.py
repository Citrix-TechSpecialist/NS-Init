...
class sslcipher_sslciphersuite_binding(base_resource) :
	...
	def cipherpriority(self) :
		ur"""This indicates priority assigned to the particular cipher.<br/>Minimum value =  1.
		"""
		try :
	...
	def get(cls, service, ciphergroupname) :
		ur""" Use this API to fetch sslcipher_sslciphersuite_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, ciphergroupname, filter_) :
		ur""" Use this API to fetch filtered set of sslcipher_sslciphersuite_binding resources.
	...
	def count(cls, service, ciphergroupname) :
		ur""" Use this API to count sslcipher_sslciphersuite_binding resources configued on NetScaler.
		"""
		try :
			obj = sslcipher_sslciphersuite_binding()
			obj.ciphergroupname = ciphergroupname
	...
	def count_filtered(cls, service, ciphergroupname, filter_) :
		ur""" Use this API to count the filtered set of sslcipher_sslciphersuite_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcipher_sslciphersuite_binding()
