...
class cmppolicy_binding(base_resource):
	...
	def cmppolicy_crvserver_bindings(self) :
		ur"""crvserver that can be bound to cmppolicy.
		"""
		try :
	...
	def cmppolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to cmppolicy.
		"""
		try :
	...
	def cmppolicy_cmpglobal_bindings(self) :
		ur"""cmpglobal that can be bound to cmppolicy.
		"""
		try :
	...
	def cmppolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to cmppolicy.
		"""
		try :
	...
	def cmppolicy_cmppolicylabel_bindings(self) :
		ur"""cmppolicylabel that can be bound to cmppolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch cmppolicy_binding resource.
		"""
		try :
