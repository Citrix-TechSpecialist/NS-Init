...
class nspbr6(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for the PBR6. Must begin with an ASCII alphabetic or underscore \(_\) character, and must contain only ASCII alphanumeric, underscore, hash \(\#\), period \(.\), space, colon \(:\), at \(@\), equals \(=\), and hyphen \(-\) characters. Cannot be changed after the PBR6 is created.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def action(self) :
		ur"""Action to perform on the outgoing IPv6 packets that match the PBR6.
	...
	@property
	def srcipv6(self) :
		ur"""IP address or range of IP addresses to match against the source IP address of an outgoing IPv6 packet. In the command line interface, separate the range with a hyphen and enclose within brackets.
		"""
		try :
	...
	@property
	def srcport(self) :
		ur"""Port number or range of port numbers to match against the source port number of an outgoing IPv6 packet. In the command line interface, separate the range with a hyphen and enclose within brackets. For example: [40-90].
		"""
		try :
	...
	@property
	def destipv6(self) :
		ur"""IP address or range of IP addresses to match against the destination IP address of an outgoing IPv6 packet.  In the command line interface, separate the range with a hyphen and enclose within brackets.
		"""
		try :
	...
	@property
	def destport(self) :
		ur"""Port number or range of port numbers to match against the destination port number of an outgoing IPv6 packet. In the command line interface, separate the range with a hyphen and enclose within brackets. For example: [40-90].
	...
	@property
	def srcmac(self) :
		ur"""MAC address to match against the source MAC address of an outgoing IPv6 packet.
		"""
		try :
			return self._srcmac
		except Exception as e:
	...
	@property
	def srcmacmask(self) :
		ur""" Used to define range of Source MAC address. It takes string of 0 and 1, 0s are for exact match and 1s for wildcard. For matching first 3 bytes of MAC address, srcMacMask value "000000111111". .<br/>Default value: "000000000000".
		"""
		try :
	...
	@property
	def protocol(self) :
		ur"""Protocol, identified by protocol name, to match against the protocol of an outgoing IPv6 packet.<br/>Possible values = ICMPV6, TCP, UDP.
		"""
		try :
	...
	def protocolnumber(self) :
		ur"""Protocol, identified by protocol number, to match against the protocol of an outgoing IPv6 packet.<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
	...
	@property
	def vlan(self) :
		ur"""ID of the VLAN. The NetScaler appliance compares the PBR6 only to the outgoing packets on the specified VLAN. If you do not specify an interface ID, the appliance compares the PBR6 to the outgoing packets on all VLANs.<br/>Minimum length =  1<br/>Maximum length =  4094.
		"""
		try :
			return self._vlan
		except Exception as e:
	...
	@property
	def vxlan(self) :
		ur"""ID of the VXLAN. The NetScaler appliance compares the PBR6 only to the outgoing packets on the specified VXLAN. If you do not specify an interface ID, the appliance compares the PBR6 to the outgoing packets on all VXLANs.<br/>Minimum length =  1<br/>Maximum length =  16777215.
		"""
		try :
			return self._vxlan
		except Exception as e:
	...
	@property
	def Interface(self) :
		ur"""ID of an interface. The NetScaler appliance compares the PBR6 only to the outgoing packets on the specified interface. If you do not specify a value, the appliance compares the PBR6 to the outgoing packets on all interfaces.
		"""
		try :
	...
	@property
	def priority(self) :
		ur"""Priority of the PBR6, which determines the order in which it is evaluated relative to the other PBR6s. If you do not specify priorities while creating PBR6s, the PBR6s are evaluated in the order in which they are created.<br/>Minimum length =  1<br/>Maximum length =  80000.
		"""
		try :
	...
	@property
	def state(self) :
		ur"""Enable or disable the PBR6. After you apply the PBR6s, the NetScaler appliance compares outgoing packets to the enabled PBR6s.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._state
		except Exception as e:
	...
	@property
	def msr(self) :
		ur"""Monitor the route specified by the Next Hop parameter.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._msr
		except Exception as e:
	...
	@property
	def nexthop(self) :
		ur"""IP address of the next hop router to which to send matching packets if action is set to ALLOW. This next hop should be directly reachable from the appliance.
		"""
		try :
	...
	def nexthopvlan(self) :
		ur"""VLAN number to be used for link local nexthop .<br/>Minimum length =  1<br/>Maximum length =  4094.
		"""
		try :
	...
	def kernelstate(self) :
		ur"""Commit status of the PBR6.<br/>Default value: NOTAPPLIED<br/>Possible values = APPLIED, NOTAPPLIED, RE-APPLY, SFAPPLIED, SFNOTAPPLIED.
		"""
		try :
	...
	@property
	def hits(self) :
		ur"""Number of hits of this PBR6.
		"""
		try :
			return self._hits
		except Exception as e:
	...
	def renumber(cls, client, resource="") :
		ur""" Use this API to renumber nspbr6.
		"""
		try :
			if type(resource) is not list :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete nspbr6.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update nspbr6.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of nspbr6 resource.
	...
	def enable(cls, client, resource) :
		ur""" Use this API to enable nspbr6.
		"""
		try :
			if type(resource) is not list :
	...
	def disable(cls, client, resource) :
		ur""" Use this API to disable nspbr6.
		"""
		try :
			if type(resource) is not list :
	...
	def clear(cls, client, resource="") :
		ur""" Use this API to clear nspbr6.
		"""
		try :
			if type(resource) is not list :
	...
	def apply(cls, client, resource) :
		ur""" Use this API to apply nspbr6.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the nspbr6 resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nspbr6()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of nspbr6 resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the nspbr6 resources configured on NetScaler.
		"""
		try :
			obj = nspbr6()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of nspbr6 resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nspbr6()
