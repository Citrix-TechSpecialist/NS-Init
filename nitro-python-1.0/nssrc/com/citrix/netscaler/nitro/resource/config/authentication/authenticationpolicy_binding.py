...
class authenticationpolicy_binding(base_resource):
	...
	def authenticationpolicy_authenticationvserver_bindings(self) :
		ur"""authenticationvserver that can be bound to authenticationpolicy.
		"""
		try :
	...
	def authenticationpolicy_authenticationpolicylabel_bindings(self) :
		ur"""authenticationpolicylabel that can be bound to authenticationpolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch authenticationpolicy_binding resource.
		"""
		try :
