...
class authenticationvserver_cspolicy_binding(base_resource) :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch authenticationvserver_cspolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of authenticationvserver_cspolicy_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count authenticationvserver_cspolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = authenticationvserver_cspolicy_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of authenticationvserver_cspolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationvserver_cspolicy_binding()
