...
class service(base_resource) :
	...
	def dnsprofilename(self) :
		ur"""Name of the DNS profile to be associated with the service. DNS profile properties will applied to the transactions processed by a service. This parameter is valid only for ADNS and ADNS-TCP services.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
