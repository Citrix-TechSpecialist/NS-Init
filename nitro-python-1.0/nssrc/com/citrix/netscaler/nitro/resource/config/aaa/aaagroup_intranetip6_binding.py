...
class aaagroup_intranetip6_binding(base_resource) :
	...
	def intranetip6(self) :
		ur"""The Intranet IP6(s) bound to the group.
		"""
		try :
	...
	@property
	def numaddr(self) :
		ur"""Numbers of ipv6 address bound starting with intranetip6.
		"""
		try :
	...
	def get(cls, service, groupname) :
		ur""" Use this API to fetch aaagroup_intranetip6_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to fetch filtered set of aaagroup_intranetip6_binding resources.
	...
	def count(cls, service, groupname) :
		ur""" Use this API to count aaagroup_intranetip6_binding resources configued on NetScaler.
		"""
		try :
			obj = aaagroup_intranetip6_binding()
			obj.groupname = groupname
	...
	def count_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to count the filtered set of aaagroup_intranetip6_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = aaagroup_intranetip6_binding()
