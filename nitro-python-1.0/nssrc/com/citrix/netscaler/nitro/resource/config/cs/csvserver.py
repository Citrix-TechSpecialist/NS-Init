...
class csvserver(base_resource) :
	...
	def servicetype(self) :
		ur"""Protocol used by the virtual server.<br/>Possible values = HTTP, SSL, TCP, FTP, RTSP, SSL_TCP, UDP, DNS, SIP_UDP, SIP_TCP, SIP_SSL, ANY, RADIUS, RDP, MYSQL, MSSQL, DIAMETER, SSL_DIAMETER, DNS_TCP, ORACLE, SMPP.
		"""
		try :
	...
	@property
	def targettype(self) :
		ur"""Virtual server target type.<br/>Possible values = GSLB.
		"""
		try :
	...
	def dnsrecordtype(self) :
		ur""".<br/>Default value: NSGSLB_IPV4<br/>Possible values = A, AAAA, CNAME, NAPTR.
		"""
		try :
	...
	def mssqlserverversion(self) :
		ur"""The version of the MSSQL server.<br/>Default value: 2008R2<br/>Possible values = 70, 2000, 2000SP1, 2005, 2008, 2008R2, 2012, 2014.
		"""
		try :
	...
	def dnsprofilename(self) :
		ur"""Name of the DNS profile to be associated with the VServer. DNS profile properties will applied to the transactions processed by a VServer. This parameter is valid only for DNS and DNS-TCP VServers.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
