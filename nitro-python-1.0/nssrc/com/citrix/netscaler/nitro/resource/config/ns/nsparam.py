...
class nsparam(base_resource) :
	...
	def __init__(self) :
		...
		self._icaports = []
		self._tcpcip = ""
		self._servicepathingressvlan = 0

	@property
	def httpport(self) :
		ur"""HTTP ports on the web server. This allows the system to perform connection off-load for any client request that has a destination port matching one of these configured ports.<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
	...
	@property
	def maxconn(self) :
		ur"""Maximum number of connections that will be made from the appliance to the web server(s) attached to it. The value entered here is applied globally to all attached servers.<br/>Default value: 0<br/>Maximum length =  4294967294.
		"""
		try :
	...
	@property
	def maxreq(self) :
		ur"""Maximum number of requests that the system can pass on a particular connection between the appliance and a server attached to it. Setting this value to 0 allows an unlimited number of requests to be passed. This value is overridden by the maximum number of requests configured on the individual service.<br/>Maximum length =  65535.
		"""
		try :
			return self._maxreq
		except Exception as e:
	...
	@property
	def cip(self) :
		ur"""Enable or disable the insertion of the actual client IP address into the HTTP header request passed from the client to one, some, or all servers attached to the system. The passed address can then be accessed through a minor modification to the server.
	...
	@property
	def cipheader(self) :
		ur"""Text that will be used as the client IP address header.<br/>Minimum length =  1.
		"""
		try :
	...
	def cookieversion(self) :
		ur"""Version of the cookie inserted by the system.<br/>Possible values = 0, 1.
		"""
		try :
	...
	def securecookie(self) :
		ur"""Enable or disable secure flag for persistence cookie.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def pmtumin(self) :
		ur"""Minimum path MTU value that NetScaler will process in the ICMP fragmentation needed message. If the ICMP message contains a value less than this value, then this value is used instead.<br/>Default value: 576<br/>Minimum length =  168<br/>Maximum length =  1500.
		"""
		try :
	...
	def pmtutimeout(self) :
		ur"""Interval, in minutes, for flushing the PMTU entries.<br/>Default value: 10<br/>Minimum length =  1<br/>Maximum length =  1440.
		"""
		try :
	...
	def ftpportrange(self) :
		ur"""Minimum and maximum port (port range) that FTP services are allowed to use.<br/>Minimum length =  1024<br/>Maximum length =  64000.
		"""
		try :
	...
	def grantquotamaxclient(self) :
		ur"""Percentage of shared quota to be granted at a time for maxClient.<br/>Default value: 10<br/>Maximum length =  100.
		"""
		try :
	...
	def exclusivequotamaxclient(self) :
		ur"""Percentage of maxClient to be given to PEs.<br/>Default value: 80<br/>Maximum length =  100.
		"""
		try :
	...
	def grantquotaspillover(self) :
		ur"""Percentage of shared quota to be granted at a time for spillover.<br/>Default value: 10<br/>Maximum length =  100.
		"""
		try :
	...
	def exclusivequotaspillover(self) :
		ur"""Percentage of maximum limit to be given to PEs.<br/>Default value: 80<br/>Maximum length =  100.
		"""
		try :
	...
	def useproxyport(self) :
		ur"""Enable/Disable use_proxy_port setting.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def internaluserlogin(self) :
		ur"""Enables/disables the internal user from logging in to the appliance. Before disabling internal user login, you must have key-based authentication set up on the appliance. The file name for the key pair must be "ns_comm_key".<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def aftpallowrandomsourceport(self) :
		ur"""Allow the FTP server to come from a random source port for active FTP data connections.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def icaports(self) :
		ur"""The ICA ports on the Web server. This allows the system to perform connection off-load for any
	...
	@property
	def tcpcip(self) :
		ur"""Enable or disable the insertion of the client TCP/IP header in TCP payload passed from the client to one, some, or all servers attached to the system. The passed address can then be accessed through a minor modification to the server.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tcpcip
		except Exception as e:
	...
	def servicepathingressvlan(self) :
		ur"""VLAN on which the subscriber traffic arrives on the appliance.<br/>Minimum length =  1.
		"""
		try :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update nsparam.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of nsparam resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the nsparam resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nsparam()
