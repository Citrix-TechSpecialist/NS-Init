...
class lsngroup_lsntransportprofile_binding(base_resource) :
	...
	def transportprofilename(self) :
		ur"""Name of the LSN transport profile to bind to the specified LSN group. Bind a profile for each protocol for which you want to specify settings.
	...
	def get(cls, service, groupname) :
		ur""" Use this API to fetch lsngroup_lsntransportprofile_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to fetch filtered set of lsngroup_lsntransportprofile_binding resources.
	...
	def count(cls, service, groupname) :
		ur""" Use this API to count lsngroup_lsntransportprofile_binding resources configued on NetScaler.
		"""
		try :
			obj = lsngroup_lsntransportprofile_binding()
			obj.groupname = groupname
	...
	def count_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to count the filtered set of lsngroup_lsntransportprofile_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsngroup_lsntransportprofile_binding()
