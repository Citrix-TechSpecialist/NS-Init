...
class auditnslogpolicy_binding(base_resource):
	...
	def auditnslogpolicy_systemglobal_bindings(self) :
		ur"""systemglobal that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_aaagroup_bindings(self) :
		ur"""aaagroup that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_vpnglobal_bindings(self) :
		ur"""vpnglobal that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_aaauser_bindings(self) :
		ur"""aaauser that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_authenticationvserver_bindings(self) :
		ur"""authenticationvserver that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_vpnvserver_bindings(self) :
		ur"""vpnvserver that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_appfwglobal_bindings(self) :
		ur"""appfwglobal that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def auditnslogpolicy_tmglobal_bindings(self) :
		ur"""tmglobal that can be bound to auditnslogpolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch auditnslogpolicy_binding resource.
		"""
		try :
