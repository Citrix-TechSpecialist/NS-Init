...
class vpnvserver_binding(base_resource):
	...
	def vpnvserver_authenticationloginschemapolicy_bindings(self) :
		ur"""authenticationloginschemapolicy that can be bound to vpnvserver.
		"""
		try :
	...
	def vpnvserver_cspolicy_bindings(self) :
		ur"""cspolicy that can be bound to vpnvserver.
		"""
		try :
	...
	def vpnvserver_icapolicy_bindings(self) :
		ur"""icapolicy that can be bound to vpnvserver.
		"""
		try :
	...
	def vpnvserver_vpnportaltheme_bindings(self) :
		ur"""vpnportaltheme that can be bound to vpnvserver.
		"""
		try :
	...
	def vpnvserver_feopolicy_bindings(self) :
		ur"""feopolicy that can be bound to vpnvserver.
		"""
		try :
	...
	def vpnvserver_intranetip6_bindings(self) :
		ur"""intranetip6 that can be bound to vpnvserver.
		"""
		try :
	...
	def vpnvserver_authenticationdfapolicy_bindings(self) :
		ur"""authenticationdfapolicy that can be bound to vpnvserver.
		"""
		try :
	...
	def vpnvserver_vpneula_bindings(self) :
		ur"""vpneula that can be bound to vpnvserver.
		"""
		try :
