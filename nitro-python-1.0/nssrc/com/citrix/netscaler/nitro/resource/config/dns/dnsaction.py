...
class dnsaction(base_resource) :
	...
	def dnsprofilename(self) :
		ur"""Name of the DNS profile to be associated with the transaction for which the action is chosen.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	@property
	def builtin(self) :
		ur"""Flag to determine whether DNS action is default or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
