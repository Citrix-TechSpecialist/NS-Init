...
class appalgparam(base_resource) :
	...
	def pptpgreidletimeout(self) :
		ur"""Interval in sec, after which data sessions of PPTP GRE is cleared.<br/>Default value: 9000<br/>Minimum length =  1<br/>Maximum length =  9000.
		"""
		try :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update appalgparam.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of appalgparam resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the appalgparam resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = appalgparam()
