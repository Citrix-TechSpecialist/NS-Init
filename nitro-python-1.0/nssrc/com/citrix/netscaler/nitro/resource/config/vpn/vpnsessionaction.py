...
class vpnsessionaction(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for the NetScaler Gateway profile (action). Must begin with an ASCII alphabetic or underscore (_) character, and must consist only of ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Cannot be changed after the profile is created.
	...
	def useraccounting(self) :
		ur"""The name of the radiusPolicy to use for RADIUS user accounting info on the session.
		"""
		try :
	...
	@property
	def winsip(self) :
		ur"""WINS server IP address to add to NetScaler Gateway for name resolution.
		"""
		try :
			return self._winsip
		except Exception as e:
	...
	def sesstimeout(self) :
		ur"""Number of minutes after which the session times out.<br/>Minimum length =  1.
		"""
		try :
	...
	def clientsecuritylog(self) :
		ur"""Set the logging of client security checks.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	@property
	def spoofiip(self) :
		ur"""IP address that the intranet application uses to route the connection through the virtual adapter.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def windowsclienttype(self) :
		ur"""Choose between two types of Windows Client\
	...
	@property
	def smartgroup(self) :
		ur"""This is the group in which the user is placed when the sessionpolicy associated with this sessionaction succeeds. The vpn session policy will do the post auth EPA check and if the check succeeds the user is placed in the group specified with smartgroup. The is_member_of (http.req.user.is_member_of) expression can then be used with policies to check if EPA has passed on the user belonging to this smartgroup.<br/>Minimum length =  1<br/>Maximum length =  64.
		"""
		try :
	...
	def proxylocalbypass(self) :
		ur"""Bypass proxy server for local addresses option in Internet Explorer and Firefox proxy server settings.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def clientcleanupprompt(self) :
		ur"""Prompt for client-side cache clean-up when a client-initiated session closes.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def clientoptions(self) :
		ur"""Display only the configured menu options when you select the "Configure NetScaler Gateway" option in the NetScaler Gateway Plug-in system tray icon for Windows.<br/>Possible values = none, all, services, filetransfer, configuration.
		"""
		try :
	...
	def clientconfiguration(self) :
		ur"""Display only the configured tabs when you select the "Configure NetSCaler Gateway" option in the NetScaler Gateway Plug-in system tray icon for Windows.<br/>Possible values = none, all, general, tunnel, trace, compression.
		"""
		try :
	...
	@property
	def sso(self) :
		ur"""Set single sign-on (SSO) for the session. When the user accesses a server, the user's logon credentials are passed to the server for authentication.<br/>Possible values = ON, OFF.
		"""
		try :
			return self._sso
		except Exception as e:
	...
	def ssocredential(self) :
		ur"""Specify whether to use the primary or secondary authentication credentials for single sign-on to the server.<br/>Possible values = PRIMARY, SECONDARY.
		"""
		try :
	...
	def windowsautologon(self) :
		ur"""Enable or disable the Windows Auto Logon for the session. If a VPN session is established after this setting is enabled, the user is automatically logged on by using Windows credentials after the system is restarted.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	@property
	def icaproxy(self) :
		ur"""Enable ICA proxy to configure secure Internet access to servers running Citrix XenApp or XenDesktop by using Citrix Receiver instead of the NetScaler Gateway Plug-in.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def securebrowse(self) :
		ur"""Allow users to connect through NetScaler Gateway to network resources from iOS and Android mobile devices with Citrix Receiver. Users do not need to establish a full VPN tunnel to access resources in the secure network.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def kcdaccount(self) :
		ur"""The kcd account details to be used in SSO.<br/>Minimum length =  1<br/>Maximum length =  32.
		"""
		try :
	...
	def rdpclientprofilename(self) :
		ur"""Name of the RDP profile associated with the vserver.<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
	...
	def windowspluginupgrade(self) :
		ur"""Option to set plugin upgrade behaviour for Win.<br/>Possible values = Always, Essential, Never.
		"""
		try :
	...
	def macpluginupgrade(self) :
		ur"""Option to set plugin upgrade behaviour for Mac.<br/>Possible values = Always, Essential, Never.
		"""
		try :
	...
	def linuxpluginupgrade(self) :
		ur"""Option to set plugin upgrade behaviour for Linux.<br/>Possible values = Always, Essential, Never.
		"""
		try :
	...
	def iconwithreceiver(self) :
		ur"""Option to decide whether to show plugin icon along with receiver.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add vpnsessionaction.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete vpnsessionaction.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update vpnsessionaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of vpnsessionaction resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the vpnsessionaction resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of vpnsessionaction resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the vpnsessionaction resources configured on NetScaler.
		"""
		try :
			obj = vpnsessionaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of vpnsessionaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnsessionaction()
