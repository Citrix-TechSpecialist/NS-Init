...
class rdpconnections(base_resource) :
	...
	@property
	def destport(self) :
		ur"""The Client IP address.<br/>Range 1 - 65535.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the rdpconnections resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = rdpconnections()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of rdpconnections resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the rdpconnections resources configured on NetScaler.
		"""
		try :
			obj = rdpconnections()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of rdpconnections resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = rdpconnections()
