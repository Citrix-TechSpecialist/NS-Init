...
class nstimeout(base_resource) :
	...
	@property
	def client(self) :
		ur"""Client idle timeout (in seconds). If zero, the service-type default value is taken when service is created.<br/>Default value: 0<br/>Maximum length =  18000.
		"""
		try :
			return self._client
		except Exception as e:
	...
	@property
	def server(self) :
		ur"""Server idle timeout (in seconds).  If zero, the service-type default value is taken when service is created.<br/>Default value: 0<br/>Maximum length =  18000.
		"""
		try :
			return self._server
		except Exception as e:
	...
	@property
	def httpclient(self) :
		ur"""Global idle timeout, in seconds, for client connections of HTTP service type. This value is over ridden by the client timeout that is configured on individual entities.<br/>Default value: 0<br/>Maximum length =  18000.
		"""
		try :
	...
	@property
	def httpserver(self) :
		ur"""Global idle timeout, in seconds, for server connections of HTTP service type. This value is over ridden by the server timeout that is configured on individual entities.<br/>Default value: 0<br/>Maximum length =  18000.
		"""
		try :
	...
	@property
	def tcpclient(self) :
		ur"""Global idle timeout, in seconds, for non-HTTP client connections of TCP service type. This value is over ridden by the client timeout that is configured on individual entities.<br/>Default value: 0<br/>Maximum length =  18000.
		"""
		try :
	...
	@property
	def tcpserver(self) :
		ur"""Global idle timeout, in seconds, for non-HTTP server connections of TCP service type. This value is over ridden by the server timeout that is configured on entities.<br/>Default value: 0<br/>Maximum length =  18000.
		"""
		try :
	...
	@property
	def anyclient(self) :
		ur"""Global idle timeout, in seconds, for non-TCP client connections. This value is over ridden by the client timeout that is configured on individual entities.<br/>Default value: 0<br/>Maximum length =  31536000.
		"""
		try :
	...
	@property
	def anyserver(self) :
		ur"""Global idle timeout, in seconds, for non TCP server connections. This value is over ridden by the server timeout that is configured on individual entities.<br/>Default value: 0<br/>Maximum length =  31536000.
		"""
		try :
	...
	def anytcpclient(self) :
		ur"""Global idle timeout, in seconds, for TCP client connections. This value takes precedence over  entity level timeout settings (vserver/service). This is applicable only to transport protocol TCP.<br/>Default value: 0<br/>Maximum length =  31536000.
		"""
		try :
	...
	def anytcpserver(self) :
		ur"""Global idle timeout, in seconds, for TCP server connections. This value takes precedence over entity level timeout settings ( vserver/service). This is applicable only to transport protocol TCP.<br/>Default value: 0<br/>Maximum length =  31536000.
		"""
		try :
	...
	def reducedfintimeout(self) :
		ur"""Alternative idle timeout, in seconds, for closed TCP NATPCB connections.<br/>Default value: 30<br/>Minimum length =  1<br/>Maximum length =  300.
		"""
		try :
	...
	def reducedrsttimeout(self) :
		ur"""Timer interval, in seconds, for abruptly terminated TCP NATPCB connections.<br/>Default value: 0<br/>Maximum length =  300.
		"""
		try :
	...
	def newconnidletimeout(self) :
		ur"""Timer interval, in seconds, for new TCP NATPCB connections on which no data was received.<br/>Default value: 4<br/>Minimum length =  1<br/>Maximum length =  120.
		"""
		try :
