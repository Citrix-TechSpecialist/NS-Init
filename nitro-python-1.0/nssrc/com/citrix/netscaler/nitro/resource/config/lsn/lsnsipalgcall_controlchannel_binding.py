...
class lsnsipalgcall_controlchannel_binding(base_resource) :
	...
	def get(cls, service, callid) :
		ur""" Use this API to fetch lsnsipalgcall_controlchannel_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, callid, filter_) :
		ur""" Use this API to fetch filtered set of lsnsipalgcall_controlchannel_binding resources.
	...
	def count(cls, service, callid) :
		ur""" Use this API to count lsnsipalgcall_controlchannel_binding resources configued on NetScaler.
		"""
		try :
			obj = lsnsipalgcall_controlchannel_binding()
			obj.callid = callid
	...
	def count_filtered(cls, service, callid, filter_) :
		ur""" Use this API to count the filtered set of lsnsipalgcall_controlchannel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsnsipalgcall_controlchannel_binding()
