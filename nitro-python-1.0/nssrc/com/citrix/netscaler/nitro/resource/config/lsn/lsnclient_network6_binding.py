...
class lsnclient_network6_binding(base_resource) :
	...
	@property
	def network(self) :
		ur"""IPv4 address(es) of the LSN subscriber(s) or subscriber network(s) on whose traffic you want the NetScaler ADC to perform Large Scale NAT.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def network6(self) :
		ur"""IPv6 address(es) of the LSN subscriber(s) or subscriber network(s) on whose traffic you want the NetScaler ADC to perform Large Scale NAT.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def td(self) :
		ur"""ID of the traffic domain on which this subscriber or the subscriber network (as specified by the network parameter) belongs. 
	...
	@property
	def netmask(self) :
		ur"""Subnet mask for the IPv4 address specified in the Network parameter.
		"""
		try :
	...
	def get(cls, service, clientname) :
		ur""" Use this API to fetch lsnclient_network6_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, clientname, filter_) :
		ur""" Use this API to fetch filtered set of lsnclient_network6_binding resources.
	...
	def count(cls, service, clientname) :
		ur""" Use this API to count lsnclient_network6_binding resources configued on NetScaler.
		"""
		try :
			obj = lsnclient_network6_binding()
			obj.clientname = clientname
	...
	def count_filtered(cls, service, clientname, filter_) :
		ur""" Use this API to count the filtered set of lsnclient_network6_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsnclient_network6_binding()
