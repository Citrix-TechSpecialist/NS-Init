...
class vlan_nsip6_binding(base_resource) :
	...
	def get(cls, service, id) :
		ur""" Use this API to fetch vlan_nsip6_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, id, filter_) :
		ur""" Use this API to fetch filtered set of vlan_nsip6_binding resources.
	...
	def count(cls, service, id) :
		ur""" Use this API to count vlan_nsip6_binding resources configued on NetScaler.
		"""
		try :
			obj = vlan_nsip6_binding()
			obj.id = id
	...
	def count_filtered(cls, service, id, filter_) :
		ur""" Use this API to count the filtered set of vlan_nsip6_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vlan_nsip6_binding()
