...
class nsip6(base_resource) :
	...
	@property
	def type(self) :
		ur"""Type of IP address to be created on the NetScaler appliance. Cannot be changed after the IP address is created.<br/>Default value: SNIP<br/>Possible values = NSIP, VIP, SNIP, GSLBsiteIP, ADNSsvcIP, RADIUSListenersvcIP, CLIP.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@property
	def iptype(self) :
		ur"""The type of the IPv6 address.<br/>Possible values = NSIP, VIP, SNIP, GSLBsiteIP, ADNSsvcIP, RADIUSListenersvcIP, CLIP.
		"""
		try :
			return self._iptype
		except Exception as e:
