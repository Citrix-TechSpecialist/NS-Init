...
class sslprofile(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for the SSL profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Cannot be changed after the profile is created.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
			return self._name
	...
	def sslprofiletype(self) :
		ur"""Type of profile. Front end profiles apply to the entity that receives requests from a client. Backend profiles apply to the entity that sends client requests to a server.<br/>Default value: FrontEnd<br/>Possible values = BackEnd, FrontEnd.
		"""
		try :
	...
	@property
	def dhcount(self) :
		ur"""Number of interactions, between the client and the NetScaler appliance, after which the DH private-public pair is regenerated. A value of zero (0) specifies infinite use (no refresh).
	...
	@property
	def dh(self) :
		ur"""State of Diffie-Hellman (DH) key exchange.
	...
	@property
	def dhfile(self) :
		ur"""The file name and path for the DH parameter.<br/>Minimum length =  1.
		"""
		try :
			return self._dhfile
		except Exception as e:
	...
	@property
	def ersacount(self) :
		ur"""The  refresh  count  for the re-generation of RSA public-key and private-key pair.<br/>Maximum length =  65534.
		"""
		try :
	...
	def sesstimeout(self) :
		ur"""The Session timeout value in seconds.<br/>Default value: 120<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	@property
	def ssl3(self) :
		ur"""State of SSLv3 protocol support for the SSL profile.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._ssl3
		except Exception as e:
	...
	@property
	def tls1(self) :
		ur"""State of TLSv1.0 protocol support for the SSL profile.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls1
		except Exception as e:
	...
	@property
	def tls11(self) :
		ur"""State of TLSv1.1 protocol support for the SSL profile.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls11
		except Exception as e:
	...
	@property
	def tls12(self) :
		ur"""State of TLSv1.2 protocol support for the SSL profile.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls12
		except Exception as e:
	...
	def cleartextport(self) :
		ur"""Port on which clear-text data is sent by the appliance to the server. Do not specify this parameter for SSL offloading with end-to-end encryption.<br/>Range 1 - 65535.
		"""
		try :
	...
	def clientauthuseboundcachain(self) :
		ur"""Certficates bound on the VIP are used for validating the client cert. Certficates came along with client cert are not used for validating the client cert.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def cipherpriority(self) :
		ur"""cipher priority.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def skipcaname(self) :
		ur"""The flag is used to indicate whether this
	...
	@property
	def builtin(self) :
		ur"""Flag to determine whether ssl profile is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
