...
class vpnparameter(base_resource) :
	...
	def clientsecuritylog(self) :
		ur"""Specifies whether or not to display all failed Client Security scans to the end user.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def encryptcsecexp(self) :
		ur"""Enable encryption of client security expressions.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def clientversions(self) :
		ur"""checkversion api.<br/>Minimum length =  1<br/>Maximum length =  100.
		"""
		try :
	...
	def rdpclientprofilename(self) :
		ur"""Name of the RDP profile associated with the vserver.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def windowspluginupgrade(self) :
		ur"""Option to set plugin upgrade behaviour for Win.<br/>Default value: Always<br/>Possible values = Always, Essential, Never.
		"""
		try :
	...
	def macpluginupgrade(self) :
		ur"""Option to set plugin upgrade behaviour for Mac.<br/>Default value: Always<br/>Possible values = Always, Essential, Never.
		"""
		try :
	...
	def linuxpluginupgrade(self) :
		ur"""Option to set plugin upgrade behaviour for Linux.<br/>Default value: Always<br/>Possible values = Always, Essential, Never.
		"""
		try :
	...
	def iconwithreceiver(self) :
		ur"""Option to decide whether to show plugin icon along with receiver icon.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def userdomains(self) :
		ur"""List of user domains specified as comma seperated value.
		"""
		try :
	...
	def icasessiontimeout(self) :
		ur"""Enable or disable ica session timeout. If enabled and in case AAA session gets terminated, ICA connections associated with that will also get terminated.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
