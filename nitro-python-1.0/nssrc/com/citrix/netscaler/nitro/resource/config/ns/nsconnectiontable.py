...
class nsconnectiontable(base_resource) :
	...
	@property
	def listen(self) :
		ur"""Display listening services only.
		"""
		try :
			return self._listen
		except Exception as e:
	...
	def connproperties(self) :
		ur"""flags used to store connection properties like client, server etc.<br/>Possible values = LINK, HASLINK, CLIENT, SERVER, NNM, MPTCP, SUBFLOW.
		"""
		try :
