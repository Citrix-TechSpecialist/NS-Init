...
class authenticationsamlpolicy_binding(base_resource):
	...
	def authenticationsamlpolicy_vpnvserver_bindings(self) :
		ur"""vpnvserver that can be bound to authenticationsamlpolicy.
		"""
		try :
	...
	def authenticationsamlpolicy_vpnglobal_bindings(self) :
		ur"""vpnglobal that can be bound to authenticationsamlpolicy.
		"""
		try :
	...
	def authenticationsamlpolicy_authenticationvserver_bindings(self) :
		ur"""authenticationvserver that can be bound to authenticationsamlpolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch authenticationsamlpolicy_binding resource.
		"""
		try :
