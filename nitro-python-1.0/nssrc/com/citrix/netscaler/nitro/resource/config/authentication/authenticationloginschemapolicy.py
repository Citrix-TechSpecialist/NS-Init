...
class authenticationloginschemapolicy(base_resource) :
	...
	@property
	def rule(self) :
		ur"""Expression which is evaluated to choose a profile for authentication.
	...
	@property
	def action(self) :
		ur"""Name of the profile to apply to requests or connections that match this policy.
	...
	@property
	def newname(self) :
		ur"""New name for the LoginSchema policy. 
	...
	@property
	def builtin(self) :
		ur"""Flag to determine if policy is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add authenticationloginschemapolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete authenticationloginschemapolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update authenticationloginschemapolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of authenticationloginschemapolicy resource.
	...
	def rename(cls, client, resource, new_name) :
		ur""" Use this API to rename a authenticationloginschemapolicy resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the authenticationloginschemapolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of authenticationloginschemapolicy resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the authenticationloginschemapolicy resources configured on NetScaler.
		"""
		try :
			obj = authenticationloginschemapolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of authenticationloginschemapolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationloginschemapolicy()
