...
class vlan_channel_binding(base_resource) :
	...
	@property
	def ownergroup(self) :
		ur"""The owner node group in a Cluster for this vlan.<br/>Default value: DEFAULT_NG<br/>Minimum length =  1.
		"""
		try :
	...
	def get(cls, service, id) :
		ur""" Use this API to fetch vlan_channel_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, id, filter_) :
		ur""" Use this API to fetch filtered set of vlan_channel_binding resources.
	...
	def count(cls, service, id) :
		ur""" Use this API to count vlan_channel_binding resources configued on NetScaler.
		"""
		try :
			obj = vlan_channel_binding()
			obj.id = id
	...
	def count_filtered(cls, service, id, filter_) :
		ur""" Use this API to count the filtered set of vlan_channel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vlan_channel_binding()
