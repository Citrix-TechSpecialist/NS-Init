...
class lbmonitor(base_resource) :
	...
	@property
	def type(self) :
		ur"""Type of monitor that you want to create.<br/>Possible values = PING, TCP, HTTP, TCP-ECV, HTTP-ECV, UDP-ECV, DNS, FTP, LDNS-PING, LDNS-TCP, LDNS-DNS, RADIUS, USER, HTTP-INLINE, SIP-UDP, SIP-TCP, LOAD, FTP-EXTENDED, SMTP, SNMP, NNTP, MYSQL, MYSQL-ECV, MSSQL-ECV, ORACLE-ECV, LDAP, POP3, CITRIX-XML-SERVICE, CITRIX-WEB-INTERFACE, DNS-TCP, RTSP, ARP, CITRIX-AG, CITRIX-AAC-LOGINPAGE, CITRIX-AAC-LAS, CITRIX-XD-DDC, ND6, CITRIX-WI-EXTENDED, DIAMETER, RADIUS_ACCOUNTING, STOREFRONT, APPC, SMPP, CITRIX-XNC-ECV, CITRIX-XDM.
		"""
		try :
			return self._type
		except Exception as e:
	...
	def mssqlprotocolversion(self) :
		ur"""Version of MSSQL server that is to be monitored.<br/>Default value: 70<br/>Possible values = 70, 2000, 2000SP1, 2005, 2008, 2008R2, 2012, 2014.
		"""
		try :
	...
	@property
	def trofscode(self) :
		ur"""Code expected when the server is under maintenance.
		"""
		try :
	...
	def trofsstring(self) :
		ur"""String expected from the server for the service to be marked as trofs. Applicable to HTTP-ECV/TCP-ECV monitors.
		"""
		try :
