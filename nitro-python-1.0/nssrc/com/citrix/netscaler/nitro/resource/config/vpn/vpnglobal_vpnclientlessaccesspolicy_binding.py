...
class vpnglobal_vpnclientlessaccesspolicy_binding(base_resource) :
	...
	def globalbindtype(self) :
		ur""".<br/>Possible values = SYSTEM_GLOBAL, VPN_GLOBAL, RNAT_GLOBAL.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a vpnglobal_vpnclientlessaccesspolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		ur""" Use this API to fetch filtered set of vpnglobal_vpnclientlessaccesspolicy_binding resources.
	...
	def count(cls, service) :
		ur""" Use this API to count vpnglobal_vpnclientlessaccesspolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_vpnclientlessaccesspolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of vpnglobal_vpnclientlessaccesspolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_vpnclientlessaccesspolicy_binding()
