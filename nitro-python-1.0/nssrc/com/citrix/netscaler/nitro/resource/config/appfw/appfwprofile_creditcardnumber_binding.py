...
class appfwprofile_creditcardnumber_binding(base_resource) :
	...
	def creditcardnumberurl(self) :
		ur"""The url for which the list of credit card numbers are needed to be bypassed from inspection.
		"""
		try :
	...
	def creditcardnumber(self) :
		ur"""The object expression that is to be excluded from safe commerce check.
		"""
		try :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch appfwprofile_creditcardnumber_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of appfwprofile_creditcardnumber_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count appfwprofile_creditcardnumber_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_creditcardnumber_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of appfwprofile_creditcardnumber_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_creditcardnumber_binding()
