...
class locationparameter(base_resource) :
	...
	@property
	def format(self) :
		ur"""Location file format.<br/>Possible values = netscaler, ip-country, ip-country-isp, ip-country-region-city, ip-country-region-city-isp, geoip-country, geoip-region, geoip-city, geoip-country-org, geoip-country-isp, geoip-city-isp-org.
		"""
		try :
			return self._format
		except Exception as e:
	...
	@property
	def format6(self) :
		ur"""Location file format.<br/>Possible values = netscaler6, geoip-country6.
		"""
		try :
