...
class tmsessionpolicy(base_resource) :
	...
	@property
	def rule(self) :
		ur"""Expression, against which traffic is evaluated. Both classic and advance expressions are supported in default partition but only advance expressions in non-default partition.
