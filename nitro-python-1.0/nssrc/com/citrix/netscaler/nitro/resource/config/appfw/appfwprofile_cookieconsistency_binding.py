...
class appfwprofile_cookieconsistency_binding(base_resource) :
	...
	@property
	def isregex(self) :
		ur"""Is the cookie name a regular expression?.<br/>Possible values = REGEX, NOTREGEX.
		"""
		try :
	...
	def cookieconsistency(self) :
		ur"""The name of the cookie to be checked.
		"""
		try :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch appfwprofile_cookieconsistency_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of appfwprofile_cookieconsistency_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count appfwprofile_cookieconsistency_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_cookieconsistency_binding()
			obj.name = name
