...
class lsnclient(base_resource) :
	...
	def add(cls, client, resource) :
		ur""" Use this API to add lsnclient.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete lsnclient.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the lsnclient resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = lsnclient()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of lsnclient resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the lsnclient resources configured on NetScaler.
		"""
		try :
			obj = lsnclient()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of lsnclient resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsnclient()
