...
class nspartition_binding(base_resource):
	...
	def partitionname(self) :
		ur"""Name of partition for which to display parameters.<br/>Minimum length =  1.
		"""
		try :
	...
	def nspartition_vlan_bindings(self) :
		ur"""vlan that can be bound to nspartition.
		"""
		try :
	...
	def nspartition_bridgegroup_bindings(self) :
		ur"""bridgegroup that can be bound to nspartition.
		"""
		try :
	...
	def get(self, service, partitionname) :
		ur""" Use this API to fetch nspartition_binding resource.
		"""
		try :
