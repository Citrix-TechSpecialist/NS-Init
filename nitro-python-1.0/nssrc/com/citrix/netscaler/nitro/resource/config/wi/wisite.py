...
class wisite(base_resource) :
	...
	@property
	def agurl(self) :
		ur"""Call back URL of the Gateway.<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
			return self._agurl
		except Exception as e:
	...
	def agcallbackurl(self) :
		ur"""Callback AGURL to which Web Interface contacts. .<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
