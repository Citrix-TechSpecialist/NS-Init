...
class aaauser_binding(base_resource):
	...
	@property
	def username(self) :
		ur"""Name of the user who has the account.<br/>Minimum length =  1.
		"""
		try :
	...
	def aaauser_intranetip_bindings(self) :
		ur"""intranetip that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_auditsyslogpolicy_bindings(self) :
		ur"""auditsyslogpolicy that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_vpnintranetapplication_bindings(self) :
		ur"""vpnintranetapplication that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_authorizationpolicy_bindings(self) :
		ur"""authorizationpolicy that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_vpnurl_bindings(self) :
		ur"""vpnurl that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_vpntrafficpolicy_bindings(self) :
		ur"""vpntrafficpolicy that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_aaagroup_bindings(self) :
		ur"""aaagroup that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_vpnsessionpolicy_bindings(self) :
		ur"""vpnsessionpolicy that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_intranetip6_bindings(self) :
		ur"""intranetip6 that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_tmsessionpolicy_bindings(self) :
		ur"""tmsessionpolicy that can be bound to aaauser.
		"""
		try :
	...
	def aaauser_auditnslogpolicy_bindings(self) :
		ur"""auditnslogpolicy that can be bound to aaauser.
		"""
		try :
	...
	def get(self, service, username) :
		ur""" Use this API to fetch aaauser_binding resource.
		"""
		try :
