...
class sslkeyfile(base_resource) :
	...
	@property
	def src(self) :
		ur"""URL specifying the protocol, host, and path, including file name, to the key file to be imported. For example, http://www.example.com/key_file.
	...
	def Import(cls, client, resource) :
		ur""" Use this API to Import sslkeyfile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		ur""" Use this API to delete sslkeyfile.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the sslkeyfile resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = sslkeyfile()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of sslkeyfile resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the sslkeyfile resources configured on NetScaler.
		"""
		try :
			obj = sslkeyfile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of sslkeyfile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslkeyfile()
