...
class vpnglobal_intranetip6_binding(base_resource) :
	...
	def intranetip6(self) :
		ur"""The intranet ip address or range.
		"""
		try :
	...
	@property
	def numaddr(self) :
		ur"""The intranet ip address or range's netmask.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a vpnglobal_intranetip6_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		ur""" Use this API to fetch filtered set of vpnglobal_intranetip6_binding resources.
	...
	def count(cls, service) :
		ur""" Use this API to count vpnglobal_intranetip6_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_intranetip6_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of vpnglobal_intranetip6_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_intranetip6_binding()
