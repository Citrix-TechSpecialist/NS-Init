...
class dnsnameserver(base_resource) :
	...
	def dnsprofilename(self) :
		ur"""Name of the DNS profile to be associated with the name server.<br/>Minimum length =  1.
		"""
		try :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update dnsnameserver.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of dnsnameserver resource.
