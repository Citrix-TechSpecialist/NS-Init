...
class snmpoption(base_resource) :
	...
	def partitionnameintrap(self) :
		ur"""Send partition name as a varbind in traps. By default the partition names are not sent as a varbind.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
