...
class vpnicadtlsconnection(base_resource) :
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the vpnicadtlsconnection resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of vpnicadtlsconnection resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the vpnicadtlsconnection resources configured on NetScaler.
		"""
		try :
			obj = vpnicadtlsconnection()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of vpnicadtlsconnection resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnicadtlsconnection()
