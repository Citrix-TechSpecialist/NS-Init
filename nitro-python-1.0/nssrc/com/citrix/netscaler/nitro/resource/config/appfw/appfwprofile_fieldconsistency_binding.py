...
class appfwprofile_fieldconsistency_binding(base_resource) :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch appfwprofile_fieldconsistency_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of appfwprofile_fieldconsistency_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count appfwprofile_fieldconsistency_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_fieldconsistency_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of appfwprofile_fieldconsistency_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_fieldconsistency_binding()
