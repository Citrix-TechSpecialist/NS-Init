...
class vpnnexthopserver(base_resource) :
	...
	@property
	def nexthopip(self) :
		ur"""IP address of the NetScaler Gateway proxy in the second DMZ.
		"""
		try :
	...
	def nexthopfqdn(self) :
		ur"""FQDN of the NetScaler Gateway proxy in the second DMZ.<br/>Minimum length =  1.
		"""
		try :
	...
	def resaddresstype(self) :
		ur"""Address Type (IPV4/IPv6) of DNS name of nextHopServer FQDN.<br/>Minimum length =  1<br/>Possible values = IPV4, IPV6.
		"""
		try :
