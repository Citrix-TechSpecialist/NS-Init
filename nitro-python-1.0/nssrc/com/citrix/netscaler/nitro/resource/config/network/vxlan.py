...
class vxlan(base_resource) :
	...
	def dynamicrouting(self) :
		ur"""Enable dynamic routing on this VXLAN.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def ipv6dynamicrouting(self) :
		ur"""Enable all IPv6 dynamic routing protocols on this VXLAN. Note: For the ENABLED setting to work, you must configure IPv6 dynamic routing protocols from the VTYSH command line.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
