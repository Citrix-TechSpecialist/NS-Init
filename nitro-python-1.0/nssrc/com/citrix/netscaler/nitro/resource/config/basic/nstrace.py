...
class nstrace(base_resource) :
	...
	def mode(self) :
		...
		Default mode: NEW_RX TXB .<br/>Default value: DEFAULT_MODE<br/>Possible values = TX, TXB, RX, IPV6, NEW_RX, C2C, NS_FR_TX, APPFW, SSLPLAIN, MPTCP.
		"""
		try :
			return self._mode
		except Exception as e:
	...
	@property
	def filesize(self) :
		ur"""File size, in MB, treshold for rollover.
		<br/>Default value: 0<br/>Maximum length =  65536.
		"""
		try :
	...
	def traceformat(self) :
		ur"""Format in which trace will be generated
	...
	@property
	def merge(self) :
		ur"""Specify how traces across PE's are merged
