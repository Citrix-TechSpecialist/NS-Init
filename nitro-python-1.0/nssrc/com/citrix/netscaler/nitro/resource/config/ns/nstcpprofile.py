...
class nstcpprofile(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name for a TCP profile. Must begin with a letter, number, or the underscore \(_\) character. Other characters allowed, after the first character, are the hyphen \(-\), period \(.\), hash \(\#\), space \( \), at \(@\), colon \(:\), and equal \(=\) characters. The name of a TCP profile cannot be changed after it is created.
	...
	@property
	def ackonpush(self) :
		ur"""Send immediate positive acknowledgement (ACK) on receipt of TCP packets with PUSH flag.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def minrto(self) :
		ur"""Minimum retransmission timeout, in milliseconds, specified in 10-millisecond increments (value must yield a whole number if divided by  10).<br/>Default value: 1000<br/>Minimum length =  10<br/>Maximum length =  64000.
		"""
		try :
			return self._minrto
		except Exception as e:
	...
	@property
	def buffersize(self) :
		ur"""TCP buffering size, in bytes.<br/>Default value: 8190<br/>Minimum length =  8190<br/>Maximum length =  20971520.
		"""
		try :
	...
	@property
	def flavor(self) :
		ur"""Set TCP congestion control algorithm.<br/>Default value: Default<br/>Possible values = Default, Westwood, BIC, CUBIC, Nile.
		"""
		try :
			return self._flavor
		except Exception as e:
	...
	def sendbuffsize(self) :
		ur"""TCP Send Buffer Size.<br/>Default value: 8190<br/>Minimum length =  8190<br/>Maximum length =  20971520.
		"""
		try :
	...
	@property
	def maxcwnd(self) :
		ur"""TCP Maximum Congestion Window.<br/>Default value: 524288<br/>Minimum length =  8190<br/>Maximum length =  20971520.
		"""
		try :
	...
	@property
	def fack(self) :
		ur"""Enable or disable FACK (Forward ACK).<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._fack
		except Exception as e:
	...
	@property
	def tcpmode(self) :
		ur"""TCP Optimization modes TRANSPARENT / ENDPOINT.<br/>Default value: TRANSPARENT<br/>Possible values = TRANSPARENT, ENDPOINT.
		"""
		try :
	...
	@property
	def builtin(self) :
		ur"""Flag to determine if tcp profile is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
