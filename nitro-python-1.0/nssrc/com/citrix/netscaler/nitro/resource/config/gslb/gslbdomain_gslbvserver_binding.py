...
class gslbdomain_gslbvserver_binding(base_resource) :
	...
	def dnsrecordtype(self) :
		ur"""The IP type for this GSLB vserver.<br/>Possible values = A, AAAA, CNAME, NAPTR.
		"""
		try :
	...
	def servicetype(self) :
		ur"""The type GSLB service.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, NNTP, ANY, SIP_UDP, SIP_TCP, SIP_SSL, RADIUS, RDP, RTSP, MYSQL, MSSQL, ORACLE.
		"""
		try :
