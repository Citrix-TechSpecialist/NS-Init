...
class bridgegroup(base_resource) :
	...
	def dynamicrouting(self) :
		ur"""Enable dynamic routing for this bridgegroup.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def partitionname(self) :
		ur"""Name of the Partition to which this vlan bound to.<br/>Minimum length =  1.
		"""
		try :
