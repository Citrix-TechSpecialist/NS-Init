...
class authenticationvserver(base_resource) :
	...
	@property
	def port(self) :
		ur"""TCP port on which the virtual server accepts connections.<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	def authenticationdomain(self) :
		ur"""The domain of the authentication cookie set by Authentication vserver.<br/>Minimum length =  3<br/>Maximum length =  252.
		"""
		try :
