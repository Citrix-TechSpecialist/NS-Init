...
class nsacl6(base_resource) :
	...
	@property
	def acl6name(self) :
		ur"""Name for the ACL6 rule. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Cannot be changed after the ACL6 rule is created.<br/>Minimum length =  1.
		"""
		try :
