...
class aaagroup_vpnintranetapplication_binding(base_resource) :
	...
	def intranetapplication(self) :
		ur"""Bind the group to the specified intranet VPN application.
		"""
		try :
	...
	def get(cls, service, groupname) :
		ur""" Use this API to fetch aaagroup_vpnintranetapplication_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to fetch filtered set of aaagroup_vpnintranetapplication_binding resources.
	...
	def count(cls, service, groupname) :
		ur""" Use this API to count aaagroup_vpnintranetapplication_binding resources configued on NetScaler.
		"""
		try :
			obj = aaagroup_vpnintranetapplication_binding()
			obj.groupname = groupname
	...
	def count_filtered(cls, service, groupname, filter_) :
		ur""" Use this API to count the filtered set of aaagroup_vpnintranetapplication_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = aaagroup_vpnintranetapplication_binding()
