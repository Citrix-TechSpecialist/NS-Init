...
class sslservice(base_resource) :
	...
	def servicename(self) :
		ur"""Name of the SSL service.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def dh(self) :
		ur"""State of Diffie-Hellman (DH) key exchange. This parameter is not applicable when configuring a backend service.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._dh
		except Exception as e:
	...
	@property
	def dhfile(self) :
		ur"""Name for and, optionally, path to the PEM-format DH parameter file to be installed. /nsconfig/ssl/ is the default path. This parameter is not applicable when configuring a backend service.<br/>Minimum length =  1.
		"""
		try :
			return self._dhfile
		except Exception as e:
	...
	@property
	def dhcount(self) :
		ur"""Number of interactions, between the client and the NetScaler appliance, after which the DH private-public pair is regenerated. A value of zero (0) specifies infinite use (no refresh). This parameter is not applicable when configuring a backend service.<br/>Maximum length =  65534.
		"""
		try :
	...
	def dhkeyexpsizelimit(self) :
		ur"""This option enables the use of NIST recommended (NIST Special Publication 800-56A) bit size for private-key size. For example, for DH params of size 2048bit, the private-key size recommended is 224bits. This is rounded-up to 256bits.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def ersacount(self) :
		ur"""Refresh count for regeneration of RSA public-key and private-key pair. Zero (0) specifies infinite usage (no refresh). 
	...
	def cipherredirect(self) :
		ur"""State of Cipher Redirect. If this parameter is set to ENABLED, you can configure an SSL virtual server or service to display meaningful error messages if the SSL handshake fails because of a cipher mismatch between the virtual server or service and the client.
		This parameter is not applicable when configuring a backend service.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def cipherurl(self) :
		ur"""URL of the page to which to redirect the client in case of a cipher mismatch. Typically, this page has a clear explanation of the error or an alternative location that the transaction can continue from.
	...
	def sslv2redirect(self) :
		ur"""State of SSLv2 Redirect. If this parameter is set to ENABLED, you can configure an SSL virtual server or service to display meaningful error messages if the SSL handshake fails because of a protocol version mismatch between the virtual server or service and the client.
		This parameter is not applicable when configuring a backend service.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def ssl2(self) :
		ur"""State of SSLv2 protocol support for the SSL service.
		This parameter is not applicable when configuring a backend service.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._ssl2
	...
	@property
	def serverauth(self) :
		ur"""State of server authentication support for the SSL service.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def dtlsprofilename(self) :
		ur"""Name of the DTLS profile that contains DTLS settings for the service.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	@property
	def sslprofile(self) :
		ur"""Name of the SSL profile that contains SSL settings for the service.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def cipherdetails(self) :
		ur"""Display details of the individual ciphers bound to the SSL service.
		"""
		try :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update sslservice.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of sslservice resource.
	...
	def get(cls, client, name="", option_="") :
		ur""" Use this API to fetch all the sslservice resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = sslservice()
	...
	def get_filtered(cls, client, filter_) :
		ur""" Use this API to fetch filtered set of sslservice resources.
	...
	def count(cls, client) :
		ur""" Use this API to count the sslservice resources configured on NetScaler.
		"""
		try :
			obj = sslservice()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		ur""" Use this API to count filtered the set of sslservice resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslservice()
