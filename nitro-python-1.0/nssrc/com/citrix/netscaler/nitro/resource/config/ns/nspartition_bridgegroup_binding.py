...
class nspartition_bridgegroup_binding(base_resource) :
	...
	def bridgegroup(self) :
		ur"""Identifier of the bridge group that is assigned to this partition.<br/>Minimum value =  1<br/>Maximum value =  1000.
		"""
		try :
	...
	def get(cls, service, partitionname) :
		ur""" Use this API to fetch nspartition_bridgegroup_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, partitionname, filter_) :
		ur""" Use this API to fetch filtered set of nspartition_bridgegroup_binding resources.
	...
	def count(cls, service, partitionname) :
		ur""" Use this API to count nspartition_bridgegroup_binding resources configued on NetScaler.
		"""
		try :
			obj = nspartition_bridgegroup_binding()
			obj.partitionname = partitionname
	...
	def count_filtered(cls, service, partitionname, filter_) :
		ur""" Use this API to count the filtered set of nspartition_bridgegroup_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nspartition_bridgegroup_binding()
