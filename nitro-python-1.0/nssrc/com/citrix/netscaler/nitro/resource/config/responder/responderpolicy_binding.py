...
class responderpolicy_binding(base_resource):
	...
	def responderpolicy_crvserver_bindings(self) :
		ur"""crvserver that can be bound to responderpolicy.
		"""
		try :
	...
	def responderpolicy_lbvserver_bindings(self) :
		ur"""lbvserver that can be bound to responderpolicy.
		"""
		try :
	...
	def responderpolicy_responderpolicylabel_bindings(self) :
		ur"""responderpolicylabel that can be bound to responderpolicy.
		"""
		try :
	...
	def responderpolicy_responderglobal_bindings(self) :
		ur"""responderglobal that can be bound to responderpolicy.
		"""
		try :
	...
	def responderpolicy_csvserver_bindings(self) :
		ur"""csvserver that can be bound to responderpolicy.
		"""
		try :
	...
	def get(self, service, name) :
		ur""" Use this API to fetch responderpolicy_binding resource.
		"""
		try :
