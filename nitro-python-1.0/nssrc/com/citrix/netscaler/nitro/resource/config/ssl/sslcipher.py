...
class sslcipher(base_resource) :
	...
	def cipherpriority(self) :
		ur"""This indicates priority assigned to the particular cipher.<br/>Minimum length =  1.
		"""
		try :
	...
	def update(cls, client, resource) :
		ur""" Use this API to update sslcipher.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		ur""" Use this API to unset the properties of sslcipher resource.
