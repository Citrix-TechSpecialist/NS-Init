...
class sslservicegroup(base_resource) :
	...
	@property
	def sslprofile(self) :
		ur"""Name of the SSL profile that contains SSL settings for the Service Group.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	@property
	def tls11(self) :
		ur"""State of TLSv1.1 protocol support for the SSL service group.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls11
		except Exception as e:
	...
	@property
	def tls12(self) :
		ur"""State of TLSv1.2 protocol support for the SSL service group.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls12
		except Exception as e:
	...
	def dhkeyexpsizelimit(self) :
		ur"""This option enables the use of NIST recommended (NIST Special Publication 800-56A) bit size for private-key size. For example, for DH params of size 2048bit, the private-key size recommended is 224bits. This is rounded-up to 256bits.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
