...
class authenticationvserver_stats(base_resource) :
	ur""" Statistics for authentication virtual server resource.
	"""
	def __init__(self) :
		self._name = ""
		self._clearstats = ""
	...
	@name.setter
	def name(self, name) :
		ur"""Name of the authentication virtual server.
		"""
		try :
			self._name = name
		except Exception as e:
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all authenticationvserver_stats resources that are configured on netscaler.
		"""
		try :
