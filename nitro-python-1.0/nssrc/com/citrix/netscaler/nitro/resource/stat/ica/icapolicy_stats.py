...
class icapolicy_stats(base_resource) :
	ur""" Statistics for ICA policy resource.
	"""
	def __init__(self) :
		self._name = ""
		self._clearstats = ""
	...
	@property
	def name(self) :
		ur"""Name of the ica policy.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def  get(cls, service, name="", option_="") :
		ur""" Use this API to fetch the statistics of all icapolicy_stats resources that are configured on netscaler.
		"""
		try :
			obj = icapolicy_stats()
			if not name :
