...
class feo_stats(base_resource) :
	...
	def imgstowebprate(self) :
		ur"""Rate (/s) counter for totalimgstowebp.
		"""
		try :
	...
	def totalimgstowebp(self) :
		ur"""The total number of images converted to WEBP format.
		"""
		try :
	...
	def totalimgstojxr(self) :
		ur"""The total number of images converted to JPEGXR format.
		"""
		try :
	...
	def imgstojxrrate(self) :
		ur"""Rate (/s) counter for totalimgstojxr.
		"""
		try :
