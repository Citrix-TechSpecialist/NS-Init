...
class ssl_stats(base_resource) :
	...
	def ssltlsv11handshakesrate(self) :
		ur"""Rate (/s) counter for ssltottlsv11handshakes.
		"""
		try :
	...
	def ssltottlsv11handshakes(self) :
		ur"""Number of SSL handshakes on TLSv1.1 on the NetScaler appliance.
		"""
		try :
	...
	def ssltotbkendtlsv11renego(self) :
		ur"""Number of back-end TLSv1.1 session renegotiations on the NetScaler appliance.
		"""
		try :
	...
	def sslbeecdhecurve256rate(self) :
		ur"""Rate (/s) counter for sslbetotecdhecurve256.
		"""
		try :
	...
	def sslbetlsv11sessionsrate(self) :
		ur"""Rate (/s) counter for sslbetottlsv11sessions.
		"""
		try :
	...
	def sslbkendtlsv11renegorate(self) :
		ur"""Rate (/s) counter for ssltotbkendtlsv11renego.
		"""
		try :
	...
	def ssltottlsv12handshakes(self) :
		ur"""Number of SSL handshakes on TLSv1.2 on the NetScaler appliance.
		"""
		try :
	...
	def ssltottlsv11renegsessions(self) :
		ur"""Number of SSL session renegotiations done on TLSv1.1.
		"""
		try :
	...
	def ssltottlsv12sessions(self) :
		ur"""Number of TLSv1.2 sessions on the NetScaler appliance.
		"""
		try :
	...
	def ssltlsv12sessionsrate(self) :
		ur"""Rate (/s) counter for ssltottlsv12sessions.
		"""
		try :
	...
	def sslbeecdhecurve224rate(self) :
		ur"""Rate (/s) counter for sslbetotecdhecurve224.
		"""
		try :
	...
	def ssltot128bitaesgcmciphers(self) :
		ur"""Number of AEC-GCM 128-bit cipher encryptions on the NetScaler appliance.
		"""
		try :
	...
	def sslbetottlsv11sessions(self) :
		ur"""Number of back-end TLSv1.1 sessions on the NetScaler appliance.
		"""
		try :
	...
	def ssloffloadbulkaesgcm128rate(self) :
		ur"""Rate (/s) counter for ssltotoffloadbulkaesgcm128.
		"""
		try :
	...
	def sslbkendtlsv12renegorate(self) :
		ur"""Rate (/s) counter for ssltotbkendtlsv12renego.
		"""
		try :
	...
	def ssltlsv11clientauthenticationsrate(self) :
		ur"""Rate (/s) counter for ssltottlsv11clientauthentications.
		"""
		try :
	...
	def ssltotoffloadbulkaesgcm256(self) :
		ur"""Number of AES-GCM 256-bit encryptions offloaded to the cryptography card.
		"""
		try :
	...
	def ssltottlsv12renegsessions(self) :
		ur"""Number of SSL session renegotiations done on TLSv1.2.
		"""
		try :
	...
	def ssltottlsv11clientauthentications(self) :
		ur"""Number of client authentications done on TLSv1.1.
		"""
		try :
	...
	def ssltlsv12renegsessionsrate(self) :
		ur"""Rate (/s) counter for ssltottlsv12renegsessions.
		"""
		try :
	...
	def sslbetotecdhecurve224(self) :
		ur"""Number of back-end ECDHE 224 curve Key exchanges  on the NetScaler appliance.
		"""
		try :
	...
	def ssltlsv11transactionsrate(self) :
		ur"""Rate (/s) counter for ssltottlsv11transactions.
		"""
		try :
	...
	def ssltlsv12clientauthenticationsrate(self) :
		ur"""Rate (/s) counter for ssltottlsv12clientauthentications.
		"""
		try :
	...
	def ssltotbkendtlsv12renego(self) :
		ur"""Number of back-end TLSv1.2 session renegotiations on the NetScaler appliance.
		"""
		try :
	...
	def ssltot256bitaesgcmciphers(self) :
		ur"""Number of AEC-GCM 256-bit cipher encryptions on the NetScaler appliance.
		"""
		try :
	...
	def sslbeecdhecurve521rate(self) :
		ur"""Rate (/s) counter for sslbetotecdhecurve521.
		"""
		try :
	...
	def ssltottlsv12transactions(self) :
		ur"""Number of TLSv1.2 transactions on the NetScaler appliance.
		"""
		try :
	...
	def ssltottlsv11sessions(self) :
		ur"""Number of TLSv1.1 sessions on the NetScaler appliance.
		"""
		try :
	...
	def ssltlsv11sessionsrate(self) :
		ur"""Rate (/s) counter for ssltottlsv11sessions.
		"""
		try :
	...
	def sslbetotecdhecurve256(self) :
		ur"""Number of back-end ECDHE 256 curve Key exchanges  on the NetScaler appliance.
		"""
		try :
	...
	def sslcryptoutilizationstat(self) :
		ur"""Utilization of the hardware crypto resource. Only valid values are 0-100%. Only works for platform with N3 chips.
		"""
		try :
	...
	def ssltottlsv11transactions(self) :
		ur"""Number of TLSv1.1 transactions on the NetScaler appliance.
		"""
		try :
	...
	def ssl128bitaesgcmciphersrate(self) :
		ur"""Rate (/s) counter for ssltot128bitaesgcmciphers.
		"""
		try :
	...
	def sslbetotecdhecurve384(self) :
		ur"""Number of back-end ECDHE 384 curve Key exchanges  on the NetScaler appliance.
		"""
		try :
	...
	def ssloffloadbulkaesgcm256rate(self) :
		ur"""Rate (/s) counter for ssltotoffloadbulkaesgcm256.
		"""
		try :
	...
	def ssltlsv12transactionsrate(self) :
		ur"""Rate (/s) counter for ssltottlsv12transactions.
		"""
		try :
	...
	def sslbetlsv12sessionsrate(self) :
		ur"""Rate (/s) counter for sslbetottlsv12sessions.
		"""
		try :
	...
	def ssltotoffloadbulkaesgcm128(self) :
		ur"""Number of AES-GCM 128-bit encryptions offloaded to the cryptography card.
		"""
		try :
	...
	def sslbetottlsv12sessions(self) :
		ur"""Number of back-end TLSv1.2 sessions on the NetScaler appliance.
		"""
		try :
	...
	def sslbetotecdhecurve521(self) :
		ur"""Number of back-end ECDHE 521 curve Key exchanges  on the NetScaler appliance.
		"""
		try :
	...
	def ssltlsv11renegsessionsrate(self) :
		ur"""Rate (/s) counter for ssltottlsv11renegsessions.
		"""
		try :
	...
	def ssltlsv12handshakesrate(self) :
		ur"""Rate (/s) counter for ssltottlsv12handshakes.
		"""
		try :
	...
	def sslbeecdhecurve384rate(self) :
		ur"""Rate (/s) counter for sslbetotecdhecurve384.
		"""
		try :
	...
	def ssl256bitaesgcmciphersrate(self) :
		ur"""Rate (/s) counter for ssltot256bitaesgcmciphers.
		"""
		try :
	...
	def ssltottlsv12clientauthentications(self) :
		ur"""Number of client authentications done on TLSv1.2.
		"""
		try :
